      ...
      },
      {
        ...
        optimizeDeps: {
          include: [
            ...
            '@codaco/fresco-ui > @tiptap/core',
            '@codaco/fresco-ui > @tiptap/extension-bullet-list',
            '@codaco/fresco-ui > @tiptap/extension-heading',
            '@codaco/fresco-ui > @tiptap/extension-ordered-list',
            '@codaco/fresco-ui > @tiptap/extension-paragraph',
            '@codaco/fresco-ui > @tiptap/extension-placeholder',
            '@codaco/fresco-ui > @tiptap/pm/model',
            '@codaco/fresco-ui > @tiptap/pm/state',
            '@codaco/fresco-ui > @tiptap/react',
            '@codaco/fresco-ui > @tiptap/starter-kit',
            '@codaco/fresco-ui > chromatic/isChromatic',
