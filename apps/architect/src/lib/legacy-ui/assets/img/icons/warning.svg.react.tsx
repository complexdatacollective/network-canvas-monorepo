...
export default function SVG({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <title>Warning</title>
      <circle
        fill="var(--warning-body, oklch(var(--platinum)))"
        cx="90"
        cy="17.5"
        r="17.5"
      />
      ...
      />
      <circle
        fill="var(--warning-body-shadow, oklch(var(--platinum--dark)))"
        cx="162.5"
        cy="142.5"
        r="17.5"
      />
      ...
      <path
        fill="var(--warning-body, oklch(var(--platinum)))"
        d="M17.5 126.68h145V160h-145z"
      />
      <circle
        fill="var(--warning-mark, oklch(var(--tomato)))"
        cx="84.29"
        cy="99.31"
        r="3"
      />
      ...
      />
      <circle
        fill="var(--warning-mark-shadow, oklch(var(--tomato--dark)))"
        cx="79.93"
        cy="48.69"
        r="3"
      />
