...
const messages = defineMessages({
  ego: {
    ...
    defaultMessage: 'Ego',
    description:
      'Visible text in the printable protocol summary’s rule sentence.',
  },
  attribute: {
    id: 'architect.query.rules.previewText.attribute',
    defaultMessage: '{value1} attribute {label}',
    description:
      'The aria-label text in the printable protocol summary’s rule sentence.',
  },
});
 ...
 * (see the rule editor's hint) — and Markdown eats the very characters that make
