...
describe('usage selectors', () => {
  it('getSociogramTypeUsageIndex()', () => {
    const result = getSociogramTypeUsageIndex(
      mockStateWithProtocol as unknown as RootState,
    );
  ...
  it('getTypeUsageIndex()', () => {
    const result = getTypeUsageIndex(
      mockStateWithProtocol as unknown as RootState,
    );
  ...
  describe('makeGetUsageForType()', () => {
    const getUsageForType = makeGetUsageForType(
      mockStateWithProtocol as unknown as RootState,
    );
  ...
  it('makeGetDeleteImpact("node", "foo")', () => {
    const getDeleteImpact = makeGetDeleteImpact(
      mockStateWithProtocol as unknown as RootState,
    );
