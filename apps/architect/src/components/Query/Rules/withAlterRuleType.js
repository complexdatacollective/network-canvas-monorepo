...
const alterRuleTypeOptions = [
  {
    label:
      "Attribute - rule based on the value of this alter type's attributes.",
    value: VARIABLE_ALTER,
  },
  {
    label:
      'Presence - based on the presence or absence of this alter type in the interview network.',
    value: TYPE_ALTER,
  },
];
...
const withAlterRuleType = compose(
  withState(
    ...
    ({ rule }) => {
      ...
      const alterRuleType = attribute ? VARIABLE_ALTER : TYPE_ALTER;
