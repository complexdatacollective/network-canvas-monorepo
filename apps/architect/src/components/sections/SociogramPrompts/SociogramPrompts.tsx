 ...
 * exclusion — see selectors.tsx's getHighlightVariablesForSubject).
 *
 * The path is the field's own name (PromptFieldsTapBehaviour.tsx's
 * `ArchitectField name="highlight.variable"`), so the refusal anchors to the
 * control that produced it.
 */
const PROMPT_PICKS = [
  { path: 'highlight.variable', writerClass: 'unvalidated' },
