...
const acceptsFile = (accepts: string[]) => (file: File) =>
  accepts.some((accept) => matchExtension(file.name, accept));
...
export const getAcceptsExtensions = (accepts: string[]) =>
  accepts.map((accept) => accept.substring(1));
