...
vi.mock('~/components/Form/Fields/VariablePicker/VariablePicker', () => ({
  VariablePickerControl: ({ label }: { label?: string }) => <div>{label}</div>,
}));
...
describe('ShapeVariableMapping threshold input', () => {
  it('can be cleared without snapping back to the committed value', () => {
