 ...
 * offer to fix — a legacy Narrative Pedigree or Geospatial color generated or
 * shipped by an older Network Canvas version, a form collecting one variable
 * twice, a prompt bound to a variable an interface owns, a disease bound to
 * one, two diseases on one variable, or two diseases sharing a name.
 *
