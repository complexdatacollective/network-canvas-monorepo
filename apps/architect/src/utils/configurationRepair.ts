 ...
 * offer to fix — an undefined color generated by the old Narrative Pedigree
 * picker, a form collecting one variable twice, a prompt bound to a variable
 * an interface owns, a disease bound to one, two diseases on one variable, or
