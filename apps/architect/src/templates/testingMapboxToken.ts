...
// `scripts/buildtime/check-mapbox-tokens.mjs` (run as `pnpm check:mapbox-tokens` in CI's
...
// Mapbox-shaped literals, and `scripts/buildtime/check-mapbox-tokens.mjs` allows only
