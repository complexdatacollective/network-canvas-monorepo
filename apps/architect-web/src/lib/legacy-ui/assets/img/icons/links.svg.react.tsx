...
export default function SVG(props: SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" {...props}>
			...
			<path fill="var(--icon-tone-primary, currentColor)" d="M10.001 31.735l2-3.465L44.6 47.09l-2 3.465z" />
			<path fill="var(--icon-tone-primary, currentColor)" d="M9.997 28.272l32.6-18.814 2 3.464-32.6 18.815z" />
			<path
