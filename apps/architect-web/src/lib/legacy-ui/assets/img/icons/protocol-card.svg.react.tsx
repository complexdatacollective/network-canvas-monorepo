...
export default function SVG(props: SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236.5 310.9" {...props}>
			{" "}
			<g id="Server">
				{" "}
				<path
				...
				<g id="NC-Flat">
					...
					<g id="NC-Nodes">
						...
						<rect
							...
							height="7.6"
						/>{" "}
						<polygon fill="var(--color-platinum-dark)" points="141.2,242.4 58.9,160 66.1,152.8 148.4,235.1" />{" "}
						<circle fill="var(--color-platinum)" cx="123.4" cy="111.1" r="15.2" />{" "}
						<circle fill="var(--color-platinum)" cx="70.1" cy="163.2" r="22.1" />{" "}
						<circle fill="var(--color-platinum)" cx="155.7" cy="248.7" r="33.2" />{" "}
					</g>{" "}
				</g>{" "}
				<path fill="var(--color-slate-blue)" d="M236.5,95.9h-66.1c-15.4,0-27.8-12.5-27.8-27.8V0L236.5,95.9z" />{" "}
			</g>{" "}
		</svg>
	);
}
