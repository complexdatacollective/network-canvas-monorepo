...
const tableVariants = cva({
  base: [
    'bg-table-row-tint my-(--space-md) break-inside-avoid overflow-hidden rounded',
  ...
  variants: {
    ...
    rotated: {
      true: [
        ...
        '[&>tbody>tr>td:first-child]:text-right [&>tbody>tr>td:first-child]:text-xs [&>tbody>tr>td:first-child]:font-semibold [&>tbody>tr>td:first-child]:tracking-widest [&>tbody>tr>td:first-child]:break-words [&>tbody>tr>td:first-child]:whitespace-nowrap [&>tbody>tr>td:first-child]:uppercase',
      ],
    },
  },
});
