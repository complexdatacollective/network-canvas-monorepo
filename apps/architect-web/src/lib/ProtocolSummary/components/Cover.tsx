...
const Cover = () => {
  ...
  return (
    <div className="[&_.protocol-card]:bg-platinum relative flex h-(--page-size-height) flex-col items-center justify-center print:h-screen [&_.protocol-card]:max-w-[12cm] [&_.protocol-card]:zoom-120 [&_.protocol-card_.protocol-name]:block">
