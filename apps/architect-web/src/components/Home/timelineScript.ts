...
export const STAGE_META: Record<StageKind, StageMeta> = {
	info: { key: "info", label: "Information", color: "hsl(237 79% 67%)", icon: interfaceIcon },
	namegen: { key: "namegen", label: "Name Generator", color: "hsl(342 77% 51%)", icon: nameGeneratorIcon },
	ordbin: { key: "ordbin", label: "Ordinal Bin", color: "hsl(27 93% 54%)", icon: menuOrdIcon },
	cat: { key: "cat", label: "Categorical Bin", color: "hsl(103 46% 56%)", icon: categoricalIcon },
	sociogram: { key: "sociogram", label: "Sociogram", color: "hsl(46 100% 47%)", icon: menuSociogramIcon },
	narrative: { key: "narrative", label: "Narrative", color: "hsl(237 79% 67%)", icon: relationshipIcon },
};
