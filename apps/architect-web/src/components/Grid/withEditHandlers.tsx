...
type OwnProps = {
  ...
  itemSelector: (
    state: RootState,
    props: { form: string; editField?: string },
  ) => GridItem | undefined;
  editField?: string;
...
const mapStateToProps = (
  ...
  const items =
    (formValueSelector(form)(state, fieldName) as GridItem[] | undefined) || [];
...
const mapDispatchToProps = (
  ...
  upsert: (fieldId: string, value: GridItem) =>
    dispatch(change(form, fieldId, value) as UnknownAction),
});
