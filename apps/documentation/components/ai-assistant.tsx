      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <motion.div
            ...
            tabIndex={0}
            className={cn(
              'bg-accent text-accent-foreground flex h-16 w-16 flex-col items-center justify-center rounded-full shadow-xl',
              'sm:h-24 sm:w-24',
            )}
        ...
        <TooltipContent className="bg-accent text-accent-foreground">
          <Paragraph variant="smallText">
            ...
            <kbd className="bg-muted text-muted-foreground pointer-events-none ml-4 inline-flex h-5 items-center gap-1 rounded border px-1.5 font-mono text-xs font-medium opacity-100 select-none">
...
const AIAssistant = () => {
  ...
  return (
    <Dialog>
      <DialogTrigger className="focusable fixed right-6 bottom-6 z-10">
        <TriggerButton />
      </DialogTrigger>
      <DialogContentEmpty>
