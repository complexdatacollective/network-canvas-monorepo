...
const selectTriggerStyles = cn(
  'text-input-foreground rounded-input border-border bg-input ring-offset-background placeholder:text-muted-foreground flex h-10 w-full items-center justify-between border px-3 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-50',
