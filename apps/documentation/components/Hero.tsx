        ...
        <div className="basis-auto items-center justify-center md:flex md:basis-1/2 lg:basis-2/5">
          ...
          >
            ...
            >
              ...
              <path
                fill="#e9c700"
                d="M287.97,180.63c-1.41.77-14.03,3.49-14.26,1.92l1.42-44.67c11.28,1.11,20.79-18.02,11.82-24.73-9.69-7.24-20.4,9.05-18.37,18.18-7.36,4.44-5-2.85-5.73-7.05-.96-5.58-4.16-12.06-10.39-12.67-16.02-1.57-14.55,16.07-4.2,22.95,1.95,1.29,8.41,3.07,8.79,4.18l-.62,44.96-13.57-2.3c-1.53-10.43-7.09-19.74-13.84-27.61-3.61-4.21-7.77-7.25-11.07-12-20.11-28.89-2.6-69.9,29.14-80.99,40.49-14.16,79.81,14.41,76.39,57.67-2.29,28.94-29.74,35.58-35.5,62.16Z"
              />
              <polygon
                fill="#e9c700"
                points="267.95 138.98 267.23 183.68 262.9 183.68 263.62 138.98 267.95 138.98"
              />
              <path
                fill="#e9c700"
                d="M257.14,131.05c-4.97,1.04-14.02-10.65-8.64-13.36,5.68-2.86,9.45,9.37,8.64,13.36Z"
              />
              <path
                fill="#e9c700"
                d="M275.16,131.05c-.5-4.95,1.38-14.08,7.97-12.67,2.34,5.48-1.79,12.74-7.97,12.67Z"
              />
