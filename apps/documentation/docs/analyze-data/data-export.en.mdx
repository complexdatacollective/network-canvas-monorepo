...
**Availability:** This option is only available in Interviewer Classic. Interviewer and Fresco always export each session as separate files—Interviewer packages them into a single `.zip` archive for download.
