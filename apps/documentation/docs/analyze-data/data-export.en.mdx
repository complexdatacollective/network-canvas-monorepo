...
- **Interviewer Classic** — see [Interviewer Online and Offline Workflows](/en/collect-data/interviewer-online-and-offline-workflows#exporting-data-to-a-cloud-file-sharing-service)
...
If you drew your background in the [Background
Creator](/en/design-protocols/key-concepts/responsive-svg-backgrounds#use-the-background-creator)
and defined zones there, leave **Use screen layout coordinates** disabled: its
exported Python or R zone-assignment script reads the normalized
`<layoutVariable>_x` / `<layoutVariable>_y` columns, which are exported by
default, and adds a categorical variable naming the zone each node falls in,
so you do not have to write that classification by hand.
...
- [Protocol and Data Workflows](/en/collect-data/protocol-and-data-workflows) - How protocols and data move through each way of running a study
- [Interviewer Online and Offline Workflows](/en/collect-data/interviewer-online-and-offline-workflows) - Deploying protocols to devices and collecting their data, with or without internet
