...
- See [Protocol and Data Workflows](/en/collect-data/protocol-and-data-workflows#data-export) for detailed Interviewer workflows
...
Interviewer 8 collects every session on the **Data** page, reached from the dashboard. Each row shows the case ID, the protocol used, when the interview started and was last updated, its completion progress, and its export status.

![The Interviewer 8 Data page, listing collected sessions with progress and export status](/assets/img/interviewer-v8-guide/resume-section.png)
