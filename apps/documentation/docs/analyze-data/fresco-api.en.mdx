...
<ImageFullWidth
  src="/assets/img/fresco-images/api-tokens-settings.png"
  alt="The API Tokens card in Fresco dashboard settings, showing the Interview Data API toggle and a table of tokens with their creation date, last-used date, and status."
/>
