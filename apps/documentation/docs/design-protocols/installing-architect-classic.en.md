...
Architect Classic is supported only when running on Windows 10 (1909) or newer, and macOS 10.15.4 or newer. Linux packages are also provided (see below).
...
Visit the [download page](https://networkcanvas.com/get-started), and download the Windows version of Architect Classic.
...
Visit the [download page](https://networkcanvas.com/get-started), and download the macOS version of Architect Classic. This is packaged in the form of a DMG disk archive.
