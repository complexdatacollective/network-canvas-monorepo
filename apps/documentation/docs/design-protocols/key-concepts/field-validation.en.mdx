...
Validation rules belong to the attribute in the codebook, so they apply everywhere the attribute is collected. As well as in a form field's **Validation** section, you can set an attribute's rules wherever you choose an attribute that participants type into:
