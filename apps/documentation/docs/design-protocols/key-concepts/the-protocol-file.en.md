...
- In **<Term name="architect-classic">Architect Classic</Term>** (the desktop app), your protocol _is_ a `.netcanvas` file on your computer. It behaves just like any other file: you can move it around, rename it, and you can (and should!) back it up.
