...
Now that you've opened Architect Web and created a protocol, the steps for adding stages through finishing off your protocol are shared with Architect Desktop. Continue with [building a protocol](/en/design-protocols/building-a-protocol).

You may also want to read:

- [Saving and backing up](/en/design-protocols/saving-and-backing-up) — how Architect Web saves protocols, and how to back them up.
...
We recommend following along using your own computer, so you should also [download and install Architect](/en/design-protocols/installing-architect-desktop)
...
Now that you've set up Architect and created a protocol, the steps for adding stages through finishing off your protocol are shared with Architect Web. Continue with [building a protocol](/en/design-protocols/building-a-protocol).
