...
Now that you've opened Architect and created a protocol, the steps for adding stages through finishing off your protocol are shared with <Term name="architect-classic">Architect Classic</Term>. Continue with [building a protocol](/en/design-protocols/building-a-protocol).
