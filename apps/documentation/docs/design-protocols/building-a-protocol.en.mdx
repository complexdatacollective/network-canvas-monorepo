...
data](/en/design-protocols/interface-documentation/small-roster-name-generator).
...
SVG Backgrounds](/en/design-protocols/key-concepts/responsive-svg-backgrounds).
