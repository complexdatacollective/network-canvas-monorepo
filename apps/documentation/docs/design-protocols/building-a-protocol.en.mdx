...
This article covers the steps for building a protocol, from adding your first stage through finishing off. These steps are largely the same in Architect and <Term name="architect-classic">Architect Classic</Term>. Choose which version you are using below to see the matching screenshots and a few version-specific notes.
...
Before you can continue, you must tell Architect which type of node this interface will create. Since this is your first name generator, you have no node types defined yet. Click the **Create New Node Type** button to begin the process of creating one.
...
Your first prompt will ask the participant to name the people with whom they have felt close to or discussed important matters. Enter the text "Within the past 6 months, who have you felt close to, or discussed important personal matters with?" and click **Save and Close**.

Click **Save and Return** on the stage editor to return to the timeline view with your new stage visible.
...
Click **Save and Close** to create your first form field.
...
After completing the form, configure the prompt for the stage. Click **Create New** in the prompts section and enter the text "Within **the past 12 months,** which **clinics** or **healthcare providers** have you visited?"
...
Click **Save and Return** to go back to the timeline view and implement the next stage.
...
As before, we will "Save and Close" and "Save and Return" to complete and save
...
Protocols built in Architect use schema 8, so they run in **Fresco** and in the new **Interviewer** app — they cannot be run in <Term name="interviewer-classic">Interviewer Classic</Term>.
...
Protocols built in <Term name="architect-classic">Architect Classic</Term> use schema 7, so they run in **<Term name="interviewer-classic">Interviewer Classic</Term>**, and can be automatically upgraded to schema 8 when uploading to **Fresco**.
