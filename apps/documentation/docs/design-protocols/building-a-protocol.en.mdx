...
In the next tutorial, [Protocol and Data Workflows](/en/collect-data/protocol-and-data-workflows), we will show you how to conduct research using the Network Canvas Interviewer app.
