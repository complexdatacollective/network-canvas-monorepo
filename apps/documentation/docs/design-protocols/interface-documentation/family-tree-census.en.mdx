...
| Is Active          | Boolean                      | Stores whether the relationship is currently active.                                                         |
| Gestational Carrier | Boolean                     | Stores whether a parent is a gestational carrier. Applies to parent edges only.                              |
