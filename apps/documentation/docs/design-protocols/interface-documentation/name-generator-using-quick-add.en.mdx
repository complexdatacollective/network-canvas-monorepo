...
![Name Generator using Quick Add Interface](/assets/img/interface-documentation/name-generators/ng-quick.png)
...
roster name generator](../interface-documentation/small-roster-name-generator) or
