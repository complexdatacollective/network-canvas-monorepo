...
A Dyad Census can include multiple [prompts](/en/design-protocols/key-concepts/prompts), each of which relates to a single edge type. Each alter pair will be considered separately for each prompt.
