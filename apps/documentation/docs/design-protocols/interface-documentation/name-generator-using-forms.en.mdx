...
Ensure you collect a value for a variable called `name` on your form, so that [node labeling](/en/design-protocols/key-concepts/node-labelling) works correctly.
