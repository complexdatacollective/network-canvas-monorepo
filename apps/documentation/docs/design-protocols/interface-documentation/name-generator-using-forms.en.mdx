...
![Name Generator using Forms Interface](/assets/img/interface-documentation/name-generators/ng-form.png)
...
Ensure you collect a value for a variable called `name` on your form, so that [node labelling](/en/get-started/advanced-topics/node-labelling) works correctly.
