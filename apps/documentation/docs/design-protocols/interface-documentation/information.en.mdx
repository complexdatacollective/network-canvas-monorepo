...
When using the Information Interface, you can incorporate one or multiple [resources](/en/design-protocols/key-concepts/resources) by either retrieving files from your resource library in Architect or locally from your device. No more than four items can be used at one time.
