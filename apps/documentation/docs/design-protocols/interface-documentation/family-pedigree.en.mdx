...
Include a variable called "name" in your form fields so that [node labeling](/en/design-protocols/key-concepts/node-labelling) works correctly and family members are displayed with meaningful labels.
...
The boolean variable each prompt records is exactly what a [Narrative Pedigree](/en/design-protocols/interface-documentation/narrative-pedigree) stage reads to draw who is affected and to infer inheritance. Pair the two stages when you want to visualize how a condition runs through the family.
