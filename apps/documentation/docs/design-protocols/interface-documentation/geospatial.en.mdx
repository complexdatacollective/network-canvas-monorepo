...
Geospatial is a schema 8 interface, so it runs only in **Fresco** and **Interviewer 7** — not in the older Interviewer 6.x app. Because it loads maps from Mapbox, it **requires an internet connection during the interview**. If your study needs to run fully offline, avoid this interface.
