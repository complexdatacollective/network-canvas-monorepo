...
Because this interface loads maps from Mapbox, it **requires an internet connection during the interview**. If your study needs to run fully offline, avoid this interface.
