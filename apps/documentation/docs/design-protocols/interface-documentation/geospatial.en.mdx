...
Geospatial is a schema 8 interface, so it runs only in **Fresco** and **Interviewer** — not in the older Interviewer Classic app. Because it loads maps from Mapbox, it **requires an internet connection during the interview**. If your study needs to run fully offline, avoid this interface.
