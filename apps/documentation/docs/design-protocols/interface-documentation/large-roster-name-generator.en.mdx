...
<InterfaceMeta type="Name Generator" creates="Creates nodes of a single type" usesprompts="true" requires="Roster data">
...
Both of these interfaces require you to have a datafile that represents your roster. See our article on [roster data](/en/design-protocols/working-with-rosters#how-to-create-a-roster) for more information about how to create such a file. Have this file, or a suitable mock file, ready before you attempt to configure either of these interfaces.
