...
Architect and <Term name="architect-classic">Architect Classic</Term> store your protocols in different ways. Understanding how — and what it means for backing up and moving your work — will help you avoid losing a protocol you have spent time building.
...
This is different from <Term name="architect-classic">Architect Classic</Term>, where your protocol is a `.netcanvas` file on your computer that you save explicitly.
...
In <Term name="architect-classic">Architect Classic</Term>, your protocol is a [`.netcanvas` file](/en/design-protocols/key-concepts/the-protocol-file) on your computer that you save and manage yourself. Unlike Architect, there is no in-browser library: you choose where the file lives, and Architect prompts you to save your changes as you work.
...
- **Follow a workflow.** The [Protocol and Data Workflows](/en/collect-data/protocol-and-data-workflows) tutorial walks through deploying protocols and organizing and backing up your files for both online and offline studies.
