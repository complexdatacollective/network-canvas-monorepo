...
We suggest [Architect Web](/en/design-protocols/architect-web) for new studies — it's the
default, needs no setup, and builds the latest schema 8 protocols. Only use Architect
Desktop if you need to create a schema 7 protocol to run in [Interviewer 6.x](/en/collect-data/interviewer).
