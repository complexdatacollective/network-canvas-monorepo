...
These two applications work together to provide a seamless [end-to-end workflow](/en/reference/tutorials/protocol-and-data-workflows) up to the point of analysis.
...
The Network Canvas tools can also be used in an offline workflow. For more information, see the [protocol and data workflows](/en/reference/tutorials/protocol-and-data-workflows#option-2-offline-workflow) tutorial.
