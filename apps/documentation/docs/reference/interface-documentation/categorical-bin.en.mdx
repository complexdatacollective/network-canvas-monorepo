...
A Categorical Bin screen can include multiple [prompts](/en/reference/key-concepts/prompts), each of which relates to a single categorical variable.
...
Group can be added as an [input control](/en/reference/key-concepts/input-controls) on
...
control](/en/reference/key-concepts/input-controls) (on a [Name
Generator](/en/reference/interface-documentation/name-generator-using-forms) or [Per
Alter Form](/en/reference/interface-documentation/per-alter-form)) or using the variable
toggling feature on the [Sociogram](/en/reference/interface-documentation/sociogram).
