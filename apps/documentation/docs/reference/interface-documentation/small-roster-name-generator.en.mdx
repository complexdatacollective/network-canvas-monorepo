...
Ensure that the roster data file used has `name` attribute to avoid seeing "No name variable!" on your cards. See our article on [node labelling](/en/desktop/advanced-topics/node-labelling) for more information on this topic.
