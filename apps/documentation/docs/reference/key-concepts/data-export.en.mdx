...
- See [Protocol and Data Workflows](/en/reference/tutorials/protocol-and-data-workflows#data-export) for detailed Interviewer workflows

**Fresco (web-based):**

- Export from the interviews page in the dashboard
- Download exported data through your browser
- See [Using Fresco](/en/run-interview/fresco/using-fresco#exporting-data) for detailed Fresco workflows
...
- See [Protocol and Data Workflows](/en/reference/tutorials/protocol-and-data-workflows) for detailed workflows
...
- See [Using Fresco](/en/run-interview/fresco/using-fresco#exporting-data) for detailed workflows
...
**See also:** [Working with Network Canvas Data in R](/en/reference/tutorials/working-with-data)
...
- [Protocol and Data Workflows](/en/reference/tutorials/protocol-and-data-workflows) - Complete workflows for protocol deployment and data export
- [Using Fresco](/en/run-interview/fresco/using-fresco) - Export data from Fresco-based studies
- [Working with Data in R](/en/reference/tutorials/working-with-data) - Detailed tutorial on analyzing Network Canvas data in R
- [Variables](/en/reference/key-concepts/variables) - Understanding the variables you'll see in exports
...
3. Review the [Working with Data tutorial](/en/reference/tutorials/working-with-data) for R analysis workflows
