...
Each variable lists the name, type, [input control](/en/reference/key-concepts/input-controls), and where it is used. You can navigate to any of the stages a variable is used in by clicking on one of the "used in" stage names just like the entity types.
...
- [Input Controls](/en/reference/key-concepts/input-controls) - Choose appropriate controls for your variables
- [Resources](/en/reference/key-concepts/resources) - Import external data files including network rosters
- [Forms](/en/reference/key-concepts/forms) - Create forms using variables from your codebook
- [Interfaces](/en/reference/key-concepts/interfaces) - Learn about Interfaces that use variables from the codebook
