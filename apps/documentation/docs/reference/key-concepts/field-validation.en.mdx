...
The validation options available depend on the [input control](/en/reference/key-concepts/input-controls) type used for the field. Different variable types support different validation rules.
...
Combine validation with [skip logic](/en/reference/key-concepts/skip-logic) to create adaptive forms.
...
- [Forms](/en/reference/key-concepts/forms) - Learn how to build forms with validated fields
- [Input Controls](/en/reference/key-concepts/input-controls) - Understand which validation options are available for each input type
- [Skip Logic](/en/reference/key-concepts/skip-logic) - Combine validation with conditional logic to create adaptive interviews
...
2. Test your validation in [Preview Mode](/en/build-protocol/architect-desktop/tutorials/building-a-protocol#preview-mode)
3. Review the [building a protocol tutorial](/en/build-protocol/architect-desktop/tutorials/building-a-protocol) to see validation in context
