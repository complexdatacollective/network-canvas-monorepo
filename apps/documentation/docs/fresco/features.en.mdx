...
If anonymous recruitment is enabled, you can also generate a unique onboarding URL for each protocol. These URLs can be shared with participants to allow them to self-enroll in your study.
