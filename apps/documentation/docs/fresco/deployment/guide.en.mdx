...
- **GitHub**: A platform for hosting and sharing code, which is owned and operated by Microsoft. The Fresco code is shared via GitHub, and you will need a GitHub account to deploy it. If you do not have a GitHub account, you can create one for free at [github.com](github.com/signup).
