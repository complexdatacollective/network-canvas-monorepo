...
We also have a [guide](/en/fresco/deployment/guide-vercel) for deploying fresco using <a href="https://www.vercel.com/" target="_blank">Vercel</a>, another cloud platform.
