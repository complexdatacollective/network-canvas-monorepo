...
the <a href="https://vercel.com" target="_blank">Vercel</a> platform, which provides both the Node.js and the PostgreSQL
...
Should you run into any issues, please consult the [troubleshooting](./troubleshooting) guide or reach out on the
<a href="https://community.networkcanvas.com" target="_blank">user community</a>.

</Tipbox>

Before continuing, ensure you have created a GitHub account and are signed in. To create a GitHub account, visit <a href="https://github.com/signup" target="_blank">github.com</a>.
...
3. Configure Environment Variables
   ...
   When entering the environment variables, do **not** include the variable key (e.g: `UPLOADTHING_SECRET=`). You should enter the value of the variable _value_, which starts after the equals (_=_) symbol (e.g: `sk_live_xxxx`)
...
4. Deploy: Click **"Deploy"** and wait for the deployment to finish.
...
If you encounter any issues during deployment, check out the [troubleshooting](../troubleshooting) article or our <a href="https://community.networkcanvas.com/" target="_blank">user community</a> for a possible solution.
...
You can optionally upload a protocol. Protocols can also be uploaded from the [protocols page](../using-fresco#uploading-protocols) once the setup steps are completed.

![Upload a protocol](/assets/img/fresco-images/fresco2.png)

### Configure participation

- **Import participants**: You can optionally upload a CSV file containing participants you wish to recruit to your study. Participants can also be uploaded from the [participants page](../using-fresco#adding-participants) once the setup steps are completed.

- **Allow anonymous recruitment**: You can enable this setting to allow your participants to join your study by visiting a URL. More information about anonymous recruitment can be found [here](../concepts/recruitment-methods#anonymous-recruitment)
