...
Thank you for taking the time to deploy Fresco! We hope you find it a valuable tool for your research and data collection.


## How much does deploying Fresco cost?

Deploying Fresco can be achieved entirely for free using the steps detailed in this guide. We built it this way to allow the broadest possible access to the software. The free deployment method does come with some limitations, such as the amount of data you can store and transfer, and the overall performance of the application.
...
Because of this, you may wish to use a paid-for cloud provider/database service if your project requires additional features, performance, or capacity. Consult the [cloud pricing](./cloud-pricing) page for more information.
...
Your UploadThing account is unique to you, meaning that noone else will have access to the files you upload within Fresco. 
