...
We recommend selecting **AWS US East 1 (N. Virginia)** as your database region.  
This region is geographically closest to Netlify’s free-tier hosting region, which can help improve connection speed between your app and database.
