...
| **Variable**                 | **Details**                                                                                                                                                                 |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **DATABASE_URL**      | A pooled connection URL for Prisma. Connection pooling allows for efficient re-use of connections, and avoids potential issues caused by large numbers of concurrent users. |
| **DATABASE_URL_UNPOOLED** | A non-pooling connection URL for Prisma. This is primarily used for database migrations when upgrading.                                                                     |
...
DATABASE_URL_UNPOOLED=postgresql://username:password@hostname:port/dbname
...
services:
  fresco:
    environment:
      - DATABASE_URL=postgresql://username:password@postgres:5432/fresco
      - DATABASE_URL_UNPOOLED=postgresql://username:password@postgres:5432/fresco
      - PUBLIC_URL=https://your-public-url.com
