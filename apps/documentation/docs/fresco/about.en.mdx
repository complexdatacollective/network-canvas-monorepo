...
manage their studies through a web-based dashboard. It also provides a way to export data in a more
familiar and user friendly way, and centralizes the management of protocols and participants.
...
alternative way to conduct interviews. It is also a pilot project, and we are actively seeking feedback from
users to help us improve it and to shape the direction we take with Studio.
