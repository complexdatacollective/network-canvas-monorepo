...
To get started using Fresco, follow our [deployment guide](/en/fresco/deployment/guide) and [create a user account](/en/fresco/deployment/create-user-account). We then suggest you explore the [features](/en/fresco/features) section to learn more about how to manage protocols, participants, and interviews in Fresco.

Should you encounter issues, we encourage you to use the search function at the top of each page, read our [FAQ](./faq), or visit our [community forum](https://community.networkcanvas.com) for support.
