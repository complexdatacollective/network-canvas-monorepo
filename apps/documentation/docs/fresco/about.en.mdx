...
Fresco is a pilot project that aims to bring Network Canvas interviews to the web browser. It does
...
If you have ever wanted be able to be able to conduct interviews remotely, or have participants use their
own devices to complete an interview, then Fresco is for you.
...
- (Deployment Guide)[/en/fresco/deployment] - To learn how to deploy Fresco for your own studies, read about the [Deployment Process](/en/fresco/deployment/) and follow the [Deployment Guide](/en/fresco/deployment/guide/).
...
- [Custom node label workers](/en/desktop/advanced-topics/node-labelling#custom-node-labelling-advanced) are not implemented. This would have posed a potential security risk.
