...
Fresco is also a pilot project, with modest scope and aims. We will not be adding significant new functionality to Fresco over its lifespan, but we _are_ actively seeking feedback from users to help us improve it and to shape the direction we take with future tools.
