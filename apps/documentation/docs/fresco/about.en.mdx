...
- **Bulk participant upload** - Participants can be added to the study in bulk by uploading a CSV file.
...
- **Limit interviews** - A configuration option that allows you to limit each participant to a single completed interview for each protocol.

### Data management

  - **Full data export** - Data can be exported from the interviews page with a variety of export options.
  - **Incomplete interview export** - A CSV of incomplete URLs can be exported from the interviews page. This can be useful for sending reminders to participants who have not yet completed their interview.
...
- [Fresco Sandbox](/en/fresco/sandbox) - A shared example deployment hosted by the projhect team, where you can explore the features of Fresco without needing to deploy it on your own.
