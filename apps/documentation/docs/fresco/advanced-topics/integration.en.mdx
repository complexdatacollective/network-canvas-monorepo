...
If you are using Loop and Merge functionality in your survey and need to pass an identifier from within a loop, you would use `${l://Field/FieldName}` instead. For most standard survey setups, `e://` is the correct choice.
