...
3. After confirming, you can follow the instructions again to [Create a Database](/en/collect-data/fresco/deployment/guide#step-4-create-your-database) and replace the environment variables in your Netlify project.
