...
We previously suggested deploying to Fresco to another cloud platform, Vercel, which offers many of the same features as Netlify. The Vercel deployment guide is [still available](/en/collect-data/fresco/deployment/guide-vercel), should you wish to use it.
...
- **Allow anonymous recruitment**: You can enable this setting to allow your participants to join your study by visiting a URL. More information about anonymous recruitment can be found in the [using Fresco](/en/collect-data/fresco/using-fresco) guide.
