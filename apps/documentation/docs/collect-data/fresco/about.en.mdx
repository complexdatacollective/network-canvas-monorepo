...
The platform that powers Fresco also underpins the new **Interviewer 8** (beta) app, which brings the same updated interview experience and data export to a downloadable desktop and tablet app. See [Running Interviews](/en/run-interview) for a comparison of the interview apps.
