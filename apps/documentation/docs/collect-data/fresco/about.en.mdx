...
Alternatively, you can read the [deployment guide](/en/collect-data/fresco/deployment/guide) to learn how to deploy Fresco for your own study.
...
- [Deployment guide](/en/collect-data/fresco/deployment/guide) - Learn how to deploy Fresco for your own studies by reading about the deployment process and following the deployment guide.
