...
3. After confirming, you can follow the instructions again to [Create a Database](/en/collect-data/fresco/guide#create-a-database) and replace the environment variables in your Netlify project.
