...
If you would like to disable all analytics, turn on **Disable Analytics** in the **Privacy** section of the settings page. Alternatively, add a `DISABLE_ANALYTICS` environment variable set to `true` to your Vercel project's environment variables and redeploy; this disables analytics and locks the setting.
