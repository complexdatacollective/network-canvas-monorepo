...
We use anonymous analytics to gather usage and error data from instances of Fresco to troubleshoot issues. No participant data, and no participant or interview identifiers, are collected or sent to us.
