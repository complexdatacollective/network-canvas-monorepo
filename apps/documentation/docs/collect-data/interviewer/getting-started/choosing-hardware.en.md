...
The fourth is **connectivity**. If you plan to use **Interviewer 7** (beta) with internet-dependent schema-8 interfaces such as [Geospatial](/en/get-started/interface-documentation/geospatial), the interview device will need a reliable internet connection in the field. **Interviewer 6.x**, and protocols that don't use such interfaces, run fully offline.
