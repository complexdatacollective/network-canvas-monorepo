...
- A **settings** control (the gear icon) that opens a small menu containing a **Text size** option — letting the participant enlarge or reduce the whole interview, useful on tablets — and an **Exit interview** action that leaves the interview and returns to the dashboard after a confirmation.
...
Beyond the settings menu's participant-facing options, there are no in-interview app settings — those live in the dashboard **Settings** area, reached after exiting the interview.
