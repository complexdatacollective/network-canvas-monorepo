...
- To follow along using your own computer or device, open [Interviewer](/en/collect-data/interviewer/about) in your web browser, or [download and install Interviewer Classic](https://networkcanvas.com/download).
