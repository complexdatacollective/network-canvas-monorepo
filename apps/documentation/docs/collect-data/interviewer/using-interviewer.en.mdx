...
<Screenshot axis="interviewer" name="lock-screen" alt="The Interviewer 8 lock screen"></Screenshot>
...
The sample protocol is built into Interviewer 8 — select it from the protocol deck on the **Home** screen to follow along. Alternatively, <DownloadLink href="/protocols/Sample Protocol v5.netcanvas">click here</DownloadLink> to download the file, and import it from the **Protocols** area.
...
<Screenshot axis="interviewer" name="small-roster" alt="The Small Roster Name Generator"></Screenshot>
...
<Screenshot axis="interviewer" name="large-roster" alt="The Large Roster Interface"></Screenshot>
