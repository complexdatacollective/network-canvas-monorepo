...
**<Term name="interviewer-classic">Interviewer Classic</Term>** is the established desktop and tablet app. It runs schema 7 protocols and works fully offline.
...
In <Term name="interviewer-classic">Interviewer Classic</Term> the card's metadata shows the protocol's [schema version](/en/get-started/protocol-schema-information) instead of an interview count, and you start interviews and manage protocols from the start screen rather than from buttons on the card itself.
