...
The sample protocol is built into Interviewer 8 — select it from the protocol deck on the **Home** screen to follow along. Alternatively, [click here](</protocols/Sample Protocol v5.netcanvas>) to download the file, and import it from the **Protocols** area.
