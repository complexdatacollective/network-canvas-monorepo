...
<InterviewerScreenshot
  name="lock-screen"
  alt="The Interviewer 8 lock screen"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="start-screen"
  alt="The Interviewer start screen"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="interviewer-ui"
  alt="The always-visible interview navigation elements"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="consent-form"
  alt="A participant consent form built using the Ego Form interface"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="ego-form"
  alt="A more full-featured ego data collection form, showing a variety of input controls"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="quick-add"
  alt="A Quick-Add Name Generator"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="side-panel"
  alt="A name generator with a side panel"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="using-forms"
  alt="A Name Generator that uses forms to collect additional data"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="blue-nodes"
  alt="Different node types are automatically styled in visually distinctive ways so that participants can always differentiate between them"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="small-roster"
  alt="The Small Roster Name Generator"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="large-roster"
  alt="The Large Roster Interface"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="per-alter-form"
  alt="The Per-Alter Form interface"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="dyad-census"
  alt="An example of the dyad-census interface"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="ordinal-bin"
  alt="The contact frequency stage, which uses the ordinal bin interface"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="cat-bin"
  alt="An example categorical bin stage"
></InterviewerScreenshot>
...
<InterviewerScreenshot
  name="export-section"
  alt="The export and manage data section"
></InterviewerScreenshot>
