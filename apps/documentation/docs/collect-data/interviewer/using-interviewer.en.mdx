...
Please note that a separate tutorial article covers how to create a protocol, called [getting started with Architect Classic](/en/design-protocols/getting-started). You should continue with the current tutorial before learning the more advanced concepts involved in protocol creation, but you can read these articles in any order you wish.
...
**Interviewer** (beta) is built on the same new platform as Fresco 4.0. It supports **schema 8** (so it can run protocols built in [Architect](/en/design-protocols/getting-started)) and is compatible with your existing protocols, while adding an improved interview experience, data export, and on-device security. Because some schema-8 interfaces (such as [Geospatial](/en/design-protocols/interface-documentation/geospatial)) need an internet connection, fully offline collection isn't always possible. It's **recommended for new studies**.
...
- Learn how to create your own protocol in [getting started with Architect Classic](/en/design-protocols/getting-started)
