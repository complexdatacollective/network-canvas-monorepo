...
We recommend following along using your own computer. Before you begin, read [Getting started with Architect Web](/en/build-protocol/architect-web) or [Getting started with Architect Desktop](/en/build-protocol/architect-desktop) to set up your tool and create a protocol.

</PrerequisitesSection>
</SummaryCard>

This article covers the steps for building a protocol — adding stages through finishing off your protocol — that are shared between Architect Web and Architect Desktop.
