...
extensively in the tutorial on [using Interviewer](/en/run-interview/interviewer/using-interviewer). If
...
This tutorial assumes you are familiar with the general concepts of the Network Canvas software, have read the [project overview](/en/project/project-information/project-overview), and have read the tutorial on [using Interviewer](/en/run-interview/interviewer/using-interviewer).
