...
We suggest [Architect Web](/en/build-protocol/architect-web) for new studies — it's the
default, needs no setup, and builds the latest schema 8 protocols. Only use Architect
Desktop if you need to create a schema 7 protocol to run in [Interviewer 6.x](/en/run-interview/interviewer).

Architect Desktop and Interviewer 6.x aren't going away. They remain fully supported and
can always be used.
...
We recommend following along using your own computer, so you should also [download and install Architect](/en/project/getting-started/downloading-desktop-software)
