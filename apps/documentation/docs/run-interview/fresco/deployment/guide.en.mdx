...
- Read the [about Fresco](/en/run-interview/fresco/about) article to understand what Fresco is and how it works.
...
We previously suggested deploying to Fresco to another cloud platform, Vercel, which offers many of the same features as Netlify. The Vercel deployment guide is [still available](/en/run-interview/fresco/deployment/guide-vercel), should you wish to use it.
...
Should you run into any issues, please consult the [troubleshooting](/en/run-interview/fresco/deployment/troubleshooting) guide or reach out to the <a href="https://community.networkcanvas.com" target="_blank">user community</a>.
...
To ensure the security of your deployment, you have **2 hours** from when the app is deployed to complete the configuration and setup. If this time elapses before completing all setup steps, your configuration will expire. To redeploy, follow our guide to [reset your database](/en/run-interview/fresco/deployment/troubleshooting#instance-expired-message-during-the-setup-process).
...
- **Allow anonymous recruitment**: You can enable this setting to allow your participants to join your study by visiting a URL. More information about anonymous recruitment can be found in the [using Fresco](/en/run-interview/fresco/using-fresco) guide.
