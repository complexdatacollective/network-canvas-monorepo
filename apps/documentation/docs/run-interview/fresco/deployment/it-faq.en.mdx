...
For background on what Fresco is and how researchers use it, see [About Fresco](/en/run-interview/fresco/about). For broader compliance guidance covering both Fresco and Interviewer, see the [GDPR Compliance Guide](/en/reference/project-information/gdpr-compliance).
...
For a fuller treatment, see the [GDPR Compliance Guide](/en/reference/project-information/gdpr-compliance).
