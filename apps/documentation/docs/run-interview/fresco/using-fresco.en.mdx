...
For comprehensive information about data export, file types, and using exported data in analysis tools, see the [Data Export guide](/en/run-interview/data-export).
