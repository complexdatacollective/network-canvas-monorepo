...
Fresco is designed to be used in conjunction with Architect for designing interview protocols. If you haven't already, you should [design your protocol in Architect](/en/build-protocol/architect-desktop) before proceeding.
...
If you have not yet designed your protocol in Architect, you should do so before proceeding. You can find a guide to designing a protocol in Architect [here](/en/build-protocol/architect-desktop).
