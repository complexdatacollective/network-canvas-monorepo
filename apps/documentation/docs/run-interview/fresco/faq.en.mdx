...
If you do not have access, you may need to [reset your database](/en/run-interview/fresco/deployment/troubleshooting#instance-expired---reset-your-database). This will result in the loss of all data and unexported interviews.
