...
**See also:** [Working with Network Canvas Data in R](/en/run-interview/working-with-data)
...
- [Working with Data in R](/en/run-interview/working-with-data) - Detailed tutorial on analyzing Network Canvas data in R
...
3. Review the [Working with Data tutorial](/en/run-interview/working-with-data) for R analysis workflows
