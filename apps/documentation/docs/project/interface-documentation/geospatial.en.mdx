...
The Geospatial Interface can include multiple [prompts](/en/project/key-concepts/prompts), each corresponding to a single text variable.
...
Consider using [network filtering](/en/project/key-concepts/network-filtering) to narrow down nodes to only those that fall within the
selectable map areas. Prior name interpreters, such as [Categorical Bins](/en/project/interface-documentation/categorical-bin) or [Per Alter Forms](/en/project/interface-documentation/per-alter-form), can be used to
