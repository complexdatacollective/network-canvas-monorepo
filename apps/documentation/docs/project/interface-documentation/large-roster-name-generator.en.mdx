...
Both of these interfaces require you to have a datafile that represents your roster. See our article on [roster data](/en/project/tutorials/working-with-rosters#how-to-create-a-roster) for more information about how to create such a file. Have this file, or a suitable mock file, ready before you attempt to configure either of these interfaces.
...
labelling](/en/project/advanced-topics/node-labelling) for more information on this topic.
