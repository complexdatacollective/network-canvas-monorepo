...
A Categorical Bin screen can include multiple [prompts](/en/project/key-concepts/prompts), each of which relates to a single categorical variable.
...
Group can be added as an [input control](/en/project/key-concepts/input-controls) on
...
control](/en/project/key-concepts/input-controls) (on a [Name
Generator](/en/project/interface-documentation/name-generator-using-forms) or [Per
Alter Form](/en/project/interface-documentation/per-alter-form)) or using the variable
toggling feature on the [Sociogram](/en/project/interface-documentation/sociogram).
