...
This interface requires you to have a datafile that represents your roster. See our article on [working with roster data](/en/project/tutorials/working-with-rosters) for more information about how to create such a file. Have this file, or a suitable mock file, ready before you attempt to configure either of these interfaces.
