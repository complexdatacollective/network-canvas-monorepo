...
Test your choices by using [Preview Mode](/en/build-protocol/architect-desktop/preview-mode) in Architect to test how controls appear and function. Get feedback from colleagues or pilot participants, and iterate based on user experience.
...
3. Review the [building a protocol tutorial](/en/build-protocol/building-a-protocol) to see input controls in context
