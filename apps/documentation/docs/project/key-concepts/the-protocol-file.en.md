...
The `.netcanvas` file contains all of the data in your protocol. So if you use any [resources](/en/build-protocol/resources), such as roster data, images, or video, these will be embedded within the file.
