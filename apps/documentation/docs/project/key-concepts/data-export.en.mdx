...
- See [Protocol and Data Workflows](/en/project/tutorials/protocol-and-data-workflows#data-export) for detailed Interviewer workflows
...
- See [Protocol and Data Workflows](/en/project/tutorials/protocol-and-data-workflows) for detailed workflows
...
**See also:** [Working with Network Canvas Data in R](/en/project/tutorials/working-with-data)
...
- [Protocol and Data Workflows](/en/project/tutorials/protocol-and-data-workflows) - Complete workflows for protocol deployment and data export
- [Using Fresco](/en/run-interview/fresco/using-fresco) - Export data from Fresco-based studies
- [Working with Data in R](/en/project/tutorials/working-with-data) - Detailed tutorial on analyzing Network Canvas data in R
- [Variables](/en/project/key-concepts/variables) - Understanding the variables you'll see in exports
...
3. Review the [Working with Data tutorial](/en/project/tutorials/working-with-data) for R analysis workflows
