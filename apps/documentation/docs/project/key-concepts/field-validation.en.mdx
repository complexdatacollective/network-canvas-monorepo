...
The validation options available depend on the [input control](/en/project/key-concepts/input-controls) type used for the field. Different variable types support different validation rules.
...
Combine validation with [skip logic](/en/project/key-concepts/skip-logic) to create adaptive forms.
...
- [Forms](/en/project/key-concepts/forms) - Learn how to build forms with validated fields
- [Input Controls](/en/project/key-concepts/input-controls) - Understand which validation options are available for each input type
- [Skip Logic](/en/project/key-concepts/skip-logic) - Combine validation with conditional logic to create adaptive interviews
