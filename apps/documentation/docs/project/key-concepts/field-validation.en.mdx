...
2. Test your validation in [Preview Mode](/en/build-protocol/architect-desktop/preview-mode)
3. Review the [building a protocol tutorial](/en/build-protocol/building-a-protocol) to see validation in context
