...
A flexible way to assign values to variables in [forms](/en/project/key-concepts/forms). By separating the visible control from the variable type, you can choose the best possible interview experience for your participant.
...
Consider using multiple toggles to indicate attributes that can then be used as part of [network filtering](/en/project/key-concepts/network-filtering) or [skip logic](/en/project/key-concepts/skip-logic).
