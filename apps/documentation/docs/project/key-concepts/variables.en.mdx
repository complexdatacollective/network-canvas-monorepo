...
Use the [Codebook](/en/build-protocol/codebook) in Architect:
...
- [Codebook](/en/build-protocol/codebook) - View and manage all variables in your protocol
- [Data Export](/en/run-interview/data-export) - Understand how variables appear in exported data
...
3. Review the [Codebook guide](/en/build-protocol/codebook) to manage variables effectively
4. Learn about [Input Controls](/en/project/key-concepts/input-controls) to choose the right controls
5. Understand [Data Export](/en/run-interview/data-export) to prepare for analysis
