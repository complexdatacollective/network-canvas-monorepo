...
3. Assigning an [input control](/en/project/key-concepts/input-controls) that determines how participants provide data
4. Optionally configuring [validation rules](/en/project/key-concepts/field-validation)
...
You create variables when configuring [Interfaces](/en/project/key-concepts/interfaces) in Architect:
...
- You can use [skip logic](/en/project/key-concepts/skip-logic) to conditionally show stages based on variable values
- You can use [network filtering](/en/project/key-concepts/network-filtering) to show only entities with specific variable values

## Creating variables

### In forms

When creating a field on a [form](/en/project/key-concepts/forms):
...
3. Select an [input control](/en/project/key-concepts/input-controls)—this sets the variable type
4. Configure any control-specific options
5. Set [validation rules](/en/project/key-concepts/field-validation) if needed
...
Use the [Codebook](/en/project/key-concepts/codebook) in Architect:
...
- [Input Controls](/en/project/key-concepts/input-controls) - Choose input controls that set variable types
- [Field Validation](/en/project/key-concepts/field-validation) - Add validation rules to variables
- [Forms](/en/project/key-concepts/forms) - Create forms that collect variable data
- [Codebook](/en/project/key-concepts/codebook) - View and manage all variables in your protocol
- [Data Export](/en/project/key-concepts/data-export) - Understand how variables appear in exported data
- [Interfaces](/en/project/key-concepts/interfaces) - Different Interfaces for collecting different types of variables
- [Skip Logic](/en/project/key-concepts/skip-logic) - Use variable values to control stage flow
- [Network Filtering](/en/project/key-concepts/network-filtering) - Filter entities based on variable values
...
3. Review the [Codebook guide](/en/project/key-concepts/codebook) to manage variables effectively
4. Learn about [Input Controls](/en/project/key-concepts/input-controls) to choose the right controls
5. Understand [Data Export](/en/project/key-concepts/data-export) to prepare for analysis
