...
Network Canvas also includes a third piece of software, [Fresco](/en/fresco), which is a tool for deploying Network Canvas protocols built in Architect to the web.
