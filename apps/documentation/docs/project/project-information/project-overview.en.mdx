...
These two applications work together to provide a seamless [end-to-end workflow](/en/project/tutorials/protocol-and-data-workflows) up to the point of analysis.
...
The Network Canvas tools can also be used in an offline workflow. For more information, see the [protocol and data workflows](/en/project/tutorials/protocol-and-data-workflows#option-2-offline-workflow) tutorial.

</TipBox>

Network Canvas also includes a third piece of software, [Fresco](/en/run-interview/fresco), which is a tool for deploying Network Canvas protocols built in Architect to the web.
