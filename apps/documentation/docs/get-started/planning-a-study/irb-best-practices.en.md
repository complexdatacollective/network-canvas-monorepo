...
- **Analytics** are optional, anonymous, and can be disabled in Fresco settings. They carry no interview data, though while they are enabled a dashboard search term can appear in the page addresses they send.
