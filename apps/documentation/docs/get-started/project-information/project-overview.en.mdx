...
Both now run in your web browser, with nothing to install. Downloadable **Classic** versions — **Architect Classic** and **Interviewer Classic** — remain available for existing schema 7 studies and offline desktop workflows.
