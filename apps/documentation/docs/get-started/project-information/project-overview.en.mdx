...
Downloadable **Classic** versions of the first two apps — **Architect Classic** and **Interviewer Classic** — remain available for existing schema 7 studies and fully-offline desktop workflows; see [Migrating from the Classic Apps](/en/get-started/migrating-from-classic).
...
The Network Canvas tools can also be used in an offline workflow. For more information, see the [Interviewer online and offline workflows](/en/collect-data/interviewer-online-and-offline-workflows#the-offline-workflow) tutorial.
