...
Interviewer comes in two supported versions: the established **Interviewer Classic**, and **Interviewer** (beta), which is built on the same new platform as Fresco, supports schema 8, and is recommended for new studies. See [Running Interviews](/en/collect-data) for a comparison of the interview apps.
