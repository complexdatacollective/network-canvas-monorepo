...
- [Deployment Guide](/en/collect-data/fresco/deployment/guide) - Deploy Fresco to compliant infrastructure
- [Advanced Deployment](/en/collect-data/fresco/deployment/advanced) - Self-hosting options for maximum control
