...
3. Assigning an [input control](/en/get-started/key-concepts/input-controls) that determines how participants provide data
4. Optionally configuring [validation rules](/en/get-started/key-concepts/field-validation)
...
You create variables when configuring [Interfaces](/en/get-started/key-concepts/interfaces) in Architect:
...
- You can use [skip logic](/en/get-started/key-concepts/skip-logic) to conditionally show stages based on variable values
- You can use [network filtering](/en/get-started/key-concepts/network-filtering) to show only entities with specific variable values

## Creating variables

### In forms

When creating a field on a [form](/en/get-started/key-concepts/forms):
...
3. Select an [input control](/en/get-started/key-concepts/input-controls)—this sets the variable type
4. Configure any control-specific options
5. Set [validation rules](/en/get-started/key-concepts/field-validation) if needed
...
Use the [Codebook](/en/design-protocols/codebook) in Architect:
...
- [Input Controls](/en/get-started/key-concepts/input-controls) - Choose input controls that set variable types
- [Field Validation](/en/get-started/key-concepts/field-validation) - Add validation rules to variables
- [Forms](/en/get-started/key-concepts/forms) - Create forms that collect variable data
- [Codebook](/en/design-protocols/codebook) - View and manage all variables in your protocol
- [Data Export](/en/analyze-data/data-export) - Understand how variables appear in exported data
- [Interfaces](/en/get-started/key-concepts/interfaces) - Different Interfaces for collecting different types of variables
- [Skip Logic](/en/get-started/key-concepts/skip-logic) - Use variable values to control stage flow
- [Network Filtering](/en/get-started/key-concepts/network-filtering) - Filter entities based on variable values
...
3. Review the [Codebook guide](/en/design-protocols/codebook) to manage variables effectively
4. Learn about [Input Controls](/en/get-started/key-concepts/input-controls) to choose the right controls
