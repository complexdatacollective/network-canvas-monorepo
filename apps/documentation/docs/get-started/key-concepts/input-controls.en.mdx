...
When creating [forms](/en/get-started/key-concepts/forms) in Architect, you must select an input control for each field. The input control you choose determines both the user interface that participants will see and the type of data that will be collected.
...
Validate appropriately by using validation to ensure data quality, but don't over-validate—too many required fields can frustrate participants. See [Field Validation](/en/get-started/key-concepts/field-validation) for details.

Test your choices by using [Preview Mode](/en/design-protocols/architect-desktop/preview-mode) in Architect to test how controls appear and function. Get feedback from colleagues or pilot participants, and iterate based on user experience.
...
- [Forms](/en/get-started/key-concepts/forms) - Learn how to build forms using input controls
- [Field Validation](/en/get-started/key-concepts/field-validation) - Add validation rules to ensure data quality
- [Variables](/en/get-started/key-concepts/variables) - Understand variable types and how they relate to input controls
...
2. Learn about [field validation](/en/get-started/key-concepts/field-validation) to ensure data quality
