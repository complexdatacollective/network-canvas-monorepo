...
The current, latest protocol schema version is **8**. Schema 8 is supported by **Architect**, **Fresco**, and the new **Interviewer** (beta) app. It is **not** supported by **Architect Classic** or **Interviewer Classic**, which support schema 7 and earlier. See [Schema version 8](#schema-version-8) below for details.
...
- **Architect**, **Fresco**, and **Interviewer** (beta) support schema 8.
...
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | --------------------- |
| 8              | New Geospatial, experimental Anonymisation, One-to-many dyad census, and Family pedigree interfaces. New `greaterThanVariable`/`lessThanVariable` validation and "contains"/"does not contain" comparators. Configurable node shape and form-field hints. | Architect                     | Fresco, Interviewer |
