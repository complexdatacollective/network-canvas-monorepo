...
Migrating a protocol happens within Architect, Fresco, and Interviewer, and is automatic. The process works as follows:
...
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | -------------------- |
| 8              | New Geospatial, experimental Anonymisation, One-to-many dyad census, and Family pedigree interfaces. New `greaterThanVariable`/`lessThanVariable` validation and "contains"/"does not contain" comparators. Configurable default and variable-driven node shapes, and form-field hints. | Architect                         | Fresco, Interviewer  |
