...
![Large Roster Name Generator Interface](/assets/img/interface-documentation/name-generators/large-roster.png)

<InterfaceMeta type="Name Generator" creates="Creates nodes of a single type" usesprompts="true">

</InterfaceMeta>

</InterfaceSummary>

Name Generators are one of the fundamental components of a network interview. They
allow your participant to create alters, thereby describing one of the two main entities
in your study's networks.

There are four name generator [Interfaces](../key-concepts/interfaces) in Network Canvas that can be added to your study, all of which can be configured within Architect.
...
Both of these interfaces require you to have a datafile that represents your roster. See our article on [roster data](/en/get-started/tutorials/working-with-rosters#how-to-create-a-roster) for more information about how to create such a file. Have this file, or a suitable mock file, ready before you attempt to configure either of these interfaces.
...
study](/en/collect-data/interviewer/getting-started/choosing-hardware).
...
labelling](/en/get-started/advanced-topics/node-labelling) for more information on this topic.

</GoodPractice>

<GoodPractice>

Configure the display options of the cards to help improve a participant's
ability to identify and disambiguate nodes within the roster.

</GoodPractice>

<GoodPractice>

Define and test appropriate searchable properties and search accuracy criteria
to help participants locate nodes within the roster.
...
Avoid using this Interface with roster datasets of 100 nodes or smaller. For
smaller rosters, use the Small Roster Name Generator.
...
Set all properties to be searchable. This will cause slow performance and less
accurate search results. Ensure that you test your search feature thoroughly.
