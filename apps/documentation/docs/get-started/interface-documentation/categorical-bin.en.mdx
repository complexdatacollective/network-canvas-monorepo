...
A Categorical Bin screen can include multiple [prompts](/en/get-started/key-concepts/prompts), each of which relates to a single categorical variable.
...
Group can be added as an [input control](/en/get-started/key-concepts/input-controls) on
...
control](/en/get-started/key-concepts/input-controls) (on a [Name
Generator](/en/get-started/interface-documentation/name-generator-using-forms) or [Per
Alter Form](/en/get-started/interface-documentation/per-alter-form)) or using the variable
toggling feature on the [Sociogram](/en/get-started/interface-documentation/sociogram).
