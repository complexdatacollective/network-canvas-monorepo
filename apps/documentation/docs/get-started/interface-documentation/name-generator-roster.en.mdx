...
![Name Generator for Roster Data Interface](/assets/uploads/stage-namegeneratorroster.png)

<InterfaceMeta type="Name Generator" creates="Creates nodes of a single type, based on data from a roster" usesprompts="true">
...
There are three name generator [Interfaces](../key-concepts/interfaces) in Network Canvas that can be added to your study, all of which can be configured within Architect.
...
This interface requires you to have a datafile that represents your roster. See our article on [working with roster data](/en/get-started/tutorials/working-with-rosters) for more information about how to create such a file. Have this file, or a suitable mock file, ready before you attempt to configure either of these interfaces.
