...
Using this interface with a large number of alters will result in a large number of screens (exponentially increasing as the number of alters increases). If you have many alters, consider using other methods to collect edges, such as the [Sociogram](/en/get-started/interface-documentation/sociogram).
