...
After setting the input control, set any variable specific options and configure the [validation options](/en/desktop/key-concepts/field-validation) you require.
