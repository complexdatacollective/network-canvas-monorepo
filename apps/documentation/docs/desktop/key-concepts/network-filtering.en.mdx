...
Similar to [skip logic](/en/desktop/key-concepts/skip-logic) rules, filtering rules have two types that can be targeted at either nodes or edges:
...
- [Skip Logic](/en/desktop/key-concepts/skip-logic) - Conditionally skip or show entire stages
- [Variables](/en/desktop/key-concepts/variables) - Create variables to use in filtering rules
- [Interfaces](/en/desktop/key-concepts/interfaces) - Understanding which Interfaces support network filtering
- [Prompts](/en/desktop/key-concepts/prompts) - Configure questions that work with filtered networks
- [Resources](/en/desktop/key-concepts/resources) - Import roster data for filtering
