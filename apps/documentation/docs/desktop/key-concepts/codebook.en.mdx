...
<StandAloneImage
  ...
  caption="Clicking the 'Manage codebook' button in Architect will navigate to the codebook view"
/>
...
<StandAloneImage
  ...
  caption="A view of codebook in Architect."
/>
...
<StandAloneImage
  ...
  caption="Entity types and variables both indicate which stages they are used in."
/>
...
<StandAloneImage
  ...
  caption="Variables marked 'not in use' and unused entity types can be deleted in the codebook view."
/>
...
<StandAloneImage
  ...
  caption="A summary of the variables from an external network file."
/>
