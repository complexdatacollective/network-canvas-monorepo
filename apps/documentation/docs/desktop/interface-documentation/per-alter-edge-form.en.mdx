...
Each edge will be assigned [variables](../reference/variable-types) using a configurable [form](../key-concepts/forms).

<StandAloneImage
  src="/assets/img/interface-documentation/per-edge-form/architect-form.png"
  caption="Form fields can be re-ordered by dragging, and deleted by clicking the right hand 'x'"
/>
