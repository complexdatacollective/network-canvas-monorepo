...
### Export data from Interviewer or Fresco

#### Interviewer

The first step in exporting data from Interviewer is to navigate to
...
For information on how to export data in Fresco, see [using Fresco](/en/fresco/using-fresco#exporting-data).
...
<ImageFullWidth
  src="/assets/img/working-with-data/vis1.png"
  alt="working-with-data/vis1.png"
/>
...
<ImageFullWidth
  src="/assets/img/working-with-data/vis2.png"
  alt="working-with-data/vis2.png"
/>
...
<ImageFullWidth
  src="/assets/img/working-with-data/vis4.png"
  alt="working-with-data/vis4.png"
/>
...
<ImageFullWidth
  src="/assets/img/working-with-data/vis5.png"
  alt="working-with-data/vis5.png"
/>
