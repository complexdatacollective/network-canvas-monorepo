...
In the next tutorial, [Protocol and Data Workflows Without Server](/en/desktop/tutorials/workflows-without-server), we will show you how to conduct research using the Network Canvas Interviewer app without using the Server app.
