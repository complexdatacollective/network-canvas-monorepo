...
This tutorial assumes you are familiar with the general concepts of the Network Canvas software, have read the [project overview](/en/desktop/project-information/project-overview), and have read the tutorial on [using Interviewer](/en/desktop/tutorials/using-interviewer).
