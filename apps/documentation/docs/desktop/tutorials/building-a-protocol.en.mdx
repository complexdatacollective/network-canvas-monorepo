...
In Fresco, the protocol name will be displayed on the protocols page. For more information about protocol management in Fresco, see the [using Fresco](/en/fresco/using-fresco#uploading-protocols) tutorial.
...
Make sure to save your file. The file name of the protocol will uniquely identify it in the Network Canvas Interviewer app and in [Fresco](/en/fresco/using-fresco#uploading-protocols).
...
- To deploy the protocol in Fresco, see our [using fresco](/en/fresco/using-fresco#uploading-protocols) tutorial.
