...
// Font configuration - using system fonts as fallback when Google Fonts unavailable
...
export default async function MainLayout(props: MainLayoutProps) {
	...
	return (
		<html lang={locale} suppressHydrationWarning className={`${fontClassName} antialiased`}>
