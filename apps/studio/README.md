...
Schema fingerprint: `aaeba04097ecdd7262eca4d7fab2e5eb45aab13fa4c8da8922b0a74770fa03c3`.
...
The instance's name is what `status` reports, and what the sign-in screen and
the rest of the interface call this deployment. Until one is given, that is
the product name.
