...
| `drafts`, `sections`, `manifests`, `leases`, `command_log`, `protocols`, `protocol_versions`, `version_sections`, `protocol_drafts`, `team_invitation_deliveries`, `audit_events` | Drizzle policy `team_isolation`, `audit_team_isolation` plus sidecar FORCE ROW LEVEL SECURITY and tenant-table DML grants.                                                                                                                                                                                                                                                                                                                                                                                                                                  |
