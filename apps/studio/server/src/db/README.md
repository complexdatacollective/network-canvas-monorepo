...
| `pool.ts`, `database-pool.ts` | The node-postgres pools that remain, and their scoped service: better-auth's adapter (stage 4 moves it), the scripts, and the surfaces not yet on Effect.                                                                                                                                                          |
