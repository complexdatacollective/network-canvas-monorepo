...
const InterviewLinkIssuedV1EventSchema = CommonUserEventSchema.extend({
  eventVersion: z.literal(1),
  eventType: z.literal('interview.link.issued'),
...
const InterviewLinkRotatedV1EventSchema = z
  .object({
    teamId: IdentifierSchema,
    teamLabel: LabelSchema,
    actorKind: z.literal('system'),
    ...
    requestId: z.uuid(),
    eventVersion: z.literal(1),
    eventType: z.literal('interview.link.rotated'),
    category: z.literal('participant_data'),
    outcome: z.literal('succeeded'),
    subjectType: z.null(),
    subjectId: z.null(),
...
export const AUDIT_EVENT_REGISTRY = {
  ...
  'message.link.read@1': {
    inputSchema: MessageDeliveryV1EventSchema,
    title: 'Interview link used for delivery',
    detailFields: ['channel'],
    sensitiveFields: [],
    createsAlert: false,
    fixture: {
  ...
  'interview.link.issued@1': {
    inputSchema: InterviewLinkIssuedV1EventSchema,
    title: 'Interview link issued',
    detailFields: ['studyId', 'waveId', 'participantId', 'reissued'],
    sensitiveFields: [],
    createsAlert: false,
    fixture: {
      ...FIXTURE_USER_COMMON,
      ...
      resourceLabel: null,
      details: {
        studyId: '00000000-0000-4000-8000-000000000022',
        waveId: '00000000-0000-4000-8000-000000000023',
        participantId: '00000000-0000-4000-8000-000000000024',
        reissued: false,
      },
    },
  },
  'interview.link.rotated@1': {
    inputSchema: InterviewLinkRotatedV1EventSchema,
    title: 'Interview link encryption rotated',
    detailFields: ['purpose'],
    sensitiveFields: [],
    createsAlert: false,
    fixture: {
