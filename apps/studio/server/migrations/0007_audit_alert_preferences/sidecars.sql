...
ALTER TABLE audit_alert_preferences FORCE ROW LEVEL SECURITY;
GRANT SELECT, INSERT, UPDATE, DELETE ON audit_events, audit_export_jobs, audit_alert_outbox, audit_alert_deliveries, audit_alert_preferences TO studio_app, studio_maintenance;
...
GRANT UPDATE (read_at) ON audit_alert_deliveries TO studio_app;
