...
ALTER TABLE "message_deliveries" ADD COLUMN "rendered_ciphertext" bytea NOT NULL;
ALTER TABLE "message_deliveries" ADD COLUMN "rendered_key_id" text NOT NULL;
ALTER TABLE "message_deliveries" ADD COLUMN "rendered_algorithm" text NOT NULL;
