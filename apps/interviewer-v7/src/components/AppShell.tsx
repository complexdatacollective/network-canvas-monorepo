...
export function AppShell({ children }: { children: ReactNode }) {
	...
	return (
		<div className="flex h-dvh w-dvw flex-col md:flex-row bg-background text-foreground">
			<nav
				aria-label="Primary"
				className="flex shrink-0 flex-row gap-1 border-b border-surface-2 bg-surface-1 p-2 md:flex-col md:gap-2 md:border-r md:border-b-0 md:p-4"
			>
				<div className="hidden md:mb-4 md:block">
					<h1 className="text-base font-bold leading-tight">Network Canvas</h1>
