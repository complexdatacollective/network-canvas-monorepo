...
const GLASS_PILL = "h-14 rounded-full border border-outline bg-surface/85 backdrop-blur-md shadow-md";
...
export function TopActionBar({ onOpenImport, onOpenData, onOpenSettings }: TopActionBarProps) {
	return (
		<div className="flex items-center gap-3">
			...
			>
				<Button
					...
					className={`${GLASS_PILL} px-6 gap-2.5`}
				>
					Import
				</Button>
			</motion.span>
