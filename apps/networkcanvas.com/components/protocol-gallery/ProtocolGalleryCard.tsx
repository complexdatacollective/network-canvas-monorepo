...
import { Eyebrow, MonoCaption } from '~/components/protocol-gallery/Eyebrow';
      ...
      >
        ...
        >
          <div>
            ...
            <MonoCaption className="mt-2">{caption}</MonoCaption>
          </div>
          <hr className="my-0" />
          <CardFacetRow
            label={t('card.edges')}
          ...
          <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1">
            <MonoCaption as="span" className="whitespace-nowrap">
            ...
            <Eyebrow
              ...
              tone="primary"
              aria-hidden
              className="flex shrink-0 items-center gap-1 font-bold whitespace-nowrap"
            >
