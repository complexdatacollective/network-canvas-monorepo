...
Architect and Interviewer update automatically, without the need for manual version management. If you have installed them from your browser as Progressive Web Apps, updates load on restart while keeping your local data secure and under your control. These upgrades have no impact on your protocols: they improve the apps' interfaces without changing the structure of your instrument.

To upgrade to the latest version of Fresco, follow the [upgrade instructions in our documentation](https://documentation.networkcanvas.com/en/collect-data/fresco/upgrading).
