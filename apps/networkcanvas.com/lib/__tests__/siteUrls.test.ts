...
describe('website site URLs', () => {
  ...
  it('resolves the shared navigation protocol gallery destination locally', () => {
    expect(
      resolveWebsiteNavigationUrl('https://protocolgallery.networkcanvas.com/'),
    ).toBe('/protocol-gallery');
  });
