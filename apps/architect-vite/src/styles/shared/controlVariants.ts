	...
	cva({
		...
		variants: {
			state: {
				...
				disabled: "pointer-events-none bg-[color-mix(in_oklch,var(--input-contrast)_30%,currentColor)]",
				readOnly: "pointer-events-none bg-[color-mix(in_oklch,var(--input-contrast)_50%,currentColor)]",
...
export const stateVariants = cva({
	...
	variants: {
		state: {
			disabled: cx("pointer-events-none cursor-not-allowed", "bg-input-contrast/5"),
...
// we ship a literal dark-colored chevron for the light scheme.
