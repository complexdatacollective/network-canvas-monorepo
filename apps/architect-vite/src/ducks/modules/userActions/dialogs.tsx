...
export const cannotSaveValidationErrorDialog = (errorMessage: string, onConfirm: () => void) => {
	const message: ReactNode = (
		<>
			<p>The protocol cannot be saved because it contains validation errors:</p>
			<pre className="bg-surface-1 p-4 rounded-md text-sm overflow-auto max-h-64">{errorMessage}</pre>

			<p className="text-sm">
				To proceed, you can revert your protocol to the last valid state and try again. If the problem persists, please
				reach out on our&nbsp;
				<ExternalLink href="https://community.networkcanvas.com/">community website.</ExternalLink>
			</p>
		</>
