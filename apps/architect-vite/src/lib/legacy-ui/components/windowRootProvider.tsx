...
interface WindowRootProviderProps {
	windowRoot: Element;
	setWindowRoot: (element: Element) => void;
}
...
const windowRootProvider = compose(
	...
	withContext(
		{
			windowRoot: null as Element | null,
			setWindowRoot: (() => {}) as (element: Element) => void,
		},
		(props: WindowRootProviderProps) => ({
