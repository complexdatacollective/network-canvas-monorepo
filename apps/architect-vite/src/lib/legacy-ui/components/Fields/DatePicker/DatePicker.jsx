...
const DatePickerInput = ({ onChange: onChangeInput, value, parameters, parentRef, placeholder }) => {
	const ref = useRef();
...
DatePickerInput.propTypes = {
	...
	parentRef: PropTypes.oneOfType([PropTypes.func, PropTypes.shape({ current: PropTypes.any })]).isRequired,
