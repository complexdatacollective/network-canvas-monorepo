...
import { allowedVariableName, uniqueByList } from "~/src/utils/validations";
import { getVariablesForSubject } from "../../../../selectors/codebook";
import { sortByLabel } from "../../../Codebook/helpers";
import ExternalLink from "../../../ExternalLink";
import { SimpleVariablePill } from "./VariablePill";

const ListItem = ({ disabled, selected, onSelect, children, setSelected, removeSelected = () => {} }) => {
...
const VariableSpotlight = (props) => {
	const { entity, type, onSelect, onCancel, onCreateOption, options, disallowCreation } = props;
