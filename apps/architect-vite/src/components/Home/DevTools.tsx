...
const DevTools = ({ runAction }: DevToolsProps) => {
	...
	return (
		<footer className="bg-surface-3 text-surface-2-foreground px-8 py-3 flex flex-wrap items-center gap-x-4 gap-y-2">
			<span className="small-heading">Dev</span>
			<Button color="platinum" size="small" onClick={installDevelopmentProtocol}>
