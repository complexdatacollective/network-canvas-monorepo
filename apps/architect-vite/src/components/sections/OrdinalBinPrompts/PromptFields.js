...
import ColorPicker from "~/src/components/Form/Fields/ColorPicker";
import NewVariableWindow, { useNewVariableWindowState } from "~/src/components/NewVariableWindow";
import Options from "~/src/components/Options";
import Tip from "~/src/components/Tip";
import { getSortOrderOptionGetter } from "~/src/components/sections/CategoricalBinPrompts/optionGetters";
import withVariableHandlers from "~/src/components/sections/CategoricalBinPrompts/withVariableHandlers";
...
const PromptFields = ({ changeForm, entity, form, type, variable, variableOptions, optionsForVariableDraft }) => {
