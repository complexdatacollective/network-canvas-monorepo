...
import withDisabledFormTitle from "~/src/components/enhancers/withDisabledFormTitle";
...
const Form = ({ handleChangeFields, form, disabled, type, entity, disableFormTitle }) => (
	<Section
		disabled={disabled}
		group
		title="Form"
