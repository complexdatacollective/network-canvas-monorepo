...
export type OneToManyDyadCensusPromptsProps = StageEditorSectionProps & {
	entity?: string;
	type?: string;
	disabled?: boolean;
};
...
)(OneToManyDyadCensusPrompts) as unknown as React.ComponentType<StageEditorSectionProps>;
