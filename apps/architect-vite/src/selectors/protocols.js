...
import { selectAllProtocols, selectProtocolById, selectRecentProtocols, selectProtocolExists } from "~/ducks/modules/protocols";
 ...
 */
export const getMostRecentProtocol = createSelector(
  [selectAllProtocols],
  (protocols) => protocols[0] || null
);
...
export const makeGetProtocolsBySearch = () =>
  createSelector(
    [selectAllProtocols, (state, searchTerm) => searchTerm],
 ...
 */
export const getHasAnyProtocols = createSelector(
  [selectAllProtocols],
