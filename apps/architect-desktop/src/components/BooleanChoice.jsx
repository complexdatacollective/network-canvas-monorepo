...
const Options = compose(connect(mapStateToProps, mapDispatchToProps))(({ form, formSelector, changeField }) => {
	const initialValues = [
	...
	return (
		<div className="type-editor__subsection">
			...
			<p>
				Each value can also be styled to indicate that it is negative. When enabled, this will make the option red when
				selected, and use a cross icon rather than a tick.
			</p>
