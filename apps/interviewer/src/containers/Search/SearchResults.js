...
class SearchResults extends Component {
  getResults() {
    const {
      hasInput, awaitingResults, results, ...rest
    } = this.props;
    ...
    if (results && results.length) {
      return <CardList className="card-list--single" items={results} {...rest} />;
    }
  ...
  render() {
    ...
    const classNames = cx('search__results', { 'search__results--collapsed': !hasInput });
