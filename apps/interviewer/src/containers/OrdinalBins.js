...
import { makeGetPromptVariable, makeGetVariableOptions, makeNetworkNodesForType } from '../selectors/interface';
...
class OrdinalBins extends PureComponent {
	...
	renderOrdinalBin = (bin, index) => {
	  const {
	    prompt, stage, activePromptVariable, updateNode,
	  } = this.props;
	  ...
	  const onDrop = ({ meta }) => {
	    ...
	    updateNode(meta[entityPrimaryKeyProperty], {}, { [activePromptVariable]: bin.value }, 'drop');
	  };
