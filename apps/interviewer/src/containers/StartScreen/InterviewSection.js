						...
						<main className="interview-section__start-new">
							<div className="content-area">
								<div className="content-area__last-used">
									...
									<ProtocolCard
										onClickHandler={() => protocolCardClickHandler(lastActiveProtocol.protocolUID)}
										attributes={{
						...
						<main className="interview-section__resume-section">
							<div className="content-area">
								<div className="content-area__last-session">
									...
									<SessionCard sessionUUID={lastActiveSession.sessionUUID} attributes={lastActiveSession.attributes} />
								</div>
