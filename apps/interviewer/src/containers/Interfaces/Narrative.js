...
class Narrative extends Component {
	...
	render() {
		...
		const edgesWithCoords = edgesToCoords(filteredEdges, { nodes: nodesWithLayout, layout: layoutVariable });

		return (
			<div className="narrative-interface">
				<div className="narrative-interface__canvas" id="narrative-interface__canvas">
					<LayoutProvider layout={layoutVariable} nodes={nodesWithLayout} edges={edgesWithCoords}>
						<Canvas
						...
						>
							...
							/>
							<ConvexHulls nodes={nodesWithLayout} groupVariable={convexHullVariable} layoutVariable={layoutVariable} />
							...
							<NodeLayout
								...
								id="NODE_LAYOUT"
								highlightAttribute={showHighlightedNodes ? highlight[highlightIndex] : null}
