...
const DyadCensus = ({
	...
	const choiceClasses = cx("dyad-census__choice", { "dyad-census__choice--invalid": !isValid });
						...
						<AnimatePresence exitBeforeEnter>
							...
							>
								<div className="dyad-census__layout">
									...
									<motion.div className={choiceClasses} variants={choiceVariants} layout initial="hide" animate="show">
