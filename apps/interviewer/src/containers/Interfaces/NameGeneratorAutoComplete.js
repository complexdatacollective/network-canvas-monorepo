...
import { makeGetAdditionalAttributes, makeGetSubjectType, makeNetworkNodesForPrompt } from "../../selectors/interface";
import {
...
class NameGeneratorAutoComplete extends Component {
	onSearchComplete = (selectedResults) => {
		const { newNodeModelData, batchAddNodes, newNodeAttributes, stage } = this.props;
...
export default compose(withPrompt, connect(makeMapStateToProps, mapDispatchToProps))(NameGeneratorAutoComplete);
