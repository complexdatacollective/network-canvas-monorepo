...
const TieStrengthCensus = (props) => {
	...
	const choiceClasses = cx("tie-strength-census__choice", { "tie-strength-census__choice--invalid": !isValid });
				...
				{!isIntroduction && (
					...
					>
						<div className="tie-strength-census__prompt">
							<Prompts currentPrompt={stage.prompts[promptIndex].id} prompts={stage.prompts} />
						</div>
...
const makeMapStateToProps = () => {
	...
	const mapStateToProps = (state, props) => {
		...
		const edgeVariableOptions = get(
			codebook,
			["edge", props.prompt.createEdge, "variables", props.prompt.edgeVariable, "options"],
			[],
		);
...
export default compose(withPrompt, connect(makeMapStateToProps))(TieStrengthCensus);
