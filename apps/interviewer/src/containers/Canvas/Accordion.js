...
class Accordion extends Component {
  constructor(props) {
	...
	render() {
	  ...
	  const toggleClasses = cx('accordion__toggle', { 'accordion__toggle--open': open });
  ...
  <div className="accordion" onClick={onAccordionToggle}>
    <div className={toggleClasses} onClick={this.toggleAccordion}>
      <h4>{label}</h4>
					&nbsp;
      <Icon name="chevron-up" color="white" className="accordion__icon accordion__icon--open" />
      <Icon name="chevron-down" color="white" className="accordion__icon accordion__icon--close" />
    </div>
