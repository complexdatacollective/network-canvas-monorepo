...
class PresetSwitcher extends PureComponent {
	...
	render() {
		...
		const navigationClasses = cx("preset-switcher__navigation ", { "preset-switcher__navigation--hidden": open });

		const freezeClasses = cx("preset-switcher__freeze", { "preset-switcher__freeze--active": isFrozen });
		...
		return (
			<div className="preset-switcher">
				...
				/>
				<div
					className={cx(navigationClasses, "preset-switcher__navigation--previous", {
				...
				<div
					className={cx(navigationClasses, "preset-switcher__navigation--next", {
