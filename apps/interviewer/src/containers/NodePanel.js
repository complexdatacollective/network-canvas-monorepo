...
class NodePanel extends PureComponent {
	...
	render = () => {
		const { title, highlight, dataSource, id, listId, minimize, onDrop, nodes, ...nodeListProps } = this.props;
...
export default compose(withExternalData("externalDataSource", "externalData"), connect(makeMapStateToProps))(NodePanel);
