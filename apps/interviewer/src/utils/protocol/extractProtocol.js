...
import { ensurePathExists, inSequence, readFile, removeDirectory, writeStream } from "../filesystem";
			...
			prepareDestination(destination)
				...
				.then(() =>
					inSequence(Object.values(zip.files), (zipObject) =>
						zipObject.dir ? extractZipDirectory(zipObject, destination) : extractZipFile(zipObject, destination),
					),
				);
	}
