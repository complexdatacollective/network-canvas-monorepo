...
} from "../src/utils/reservedAttributes";
	...
	nodes: [
		{
			...
			type: "mock-node-type",
			[entityAttributesProperty]: { "mock-uuid-1": "Jimbo", "mock-uuid-2": 20, "mock-uuid-3": { x: 10, y: 50 } },
		},
		{
			[entityPrimaryKeyProperty]: "20",
			type: "mock-node-type",
			[entityAttributesProperty]: { "mock-uuid-1": "Jambo", "mock-uuid-2": 30, "mock-uuid-3": { x: 20, y: 20 } },
		},
	],
