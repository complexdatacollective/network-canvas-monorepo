...
const createDirectory = (targetPath) => fse.mkdir(targetPath)
  .then(() => targetPath)
  .catch((error) => {
...
const removeDirectory = (targetPath) => new Promise((resolve, reject) => {
  try {
    if (
...
const writeStream = (destination, stream) => new Promise((resolve, reject) => {
  try {
    stream
...
const createWriteStream = (destination) => new Promise((resolve, reject) => {
  try {
