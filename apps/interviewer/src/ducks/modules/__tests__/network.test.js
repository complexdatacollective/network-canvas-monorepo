...
describe("network reducer", () => {
	it("should handle BATCH_ADD_NODE", () => {
		...
		const action = actionCreators.batchAddNodes(mockNodeList, mockStageAttributes, mockProtocolAttributes);
	...
	it("should handle REMOVE_EDGE", () => {
		...
		expect(reducer({ ...mockState, edges: [edgeA, edgeB] }, { type: actionTypes.REMOVE_EDGE, edgeId: 123 })).toEqual({
			...mockState,
			edges: [edgeB],
		});
	});
