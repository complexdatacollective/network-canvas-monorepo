...
import { actionCreators as networkActions, actionTypes as networkActionTypes } from "../network";
...
describe("sessions", () => {
	...
	describe("actions", () => {
		it("batchAddNodes should dispatch network.batchAddNodes action with sessionId", () => {
			...
			expect(networkActions.batchAddNodes.mock.calls).toEqual([[nodeList, attributeData, defaultProperties]]);
