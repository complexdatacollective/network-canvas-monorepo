...
const messages = defineMessages({
  description: {
    id: 'interviewer.developmentProtocol.description',
    defaultMessage:
      'The Network Canvas development protocol — exercises every stage type and is bundled into development builds for testing.',
    description:
      'Development-only administration teaser for the bundled development protocol.',
  },
});
