...
const SettingsMenu = (props) => {
	...
	return (
		<AnimatePresence>
			{settingsMenuOpen && (
				<motion.div className="settings-menu" layout variants={baseVariants} animate="show" initial="hide" exit="hide">
					<motion.article variants={baseVariants} layout className="settings-menu__wrapper">
