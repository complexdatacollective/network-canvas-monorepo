...
const node1 = {
	_uid: 1,
	type: "person",
	[entityAttributesProperty]: { role: ["a"], name: "alpha", personLayout: [1, 1] },
};
const node2 = {
	_uid: 2,
	type: "person",
	[entityAttributesProperty]: { role: ["a"], name: "foxtrot", personLayout: null },
};
const node3 = {
	_uid: 3,
	type: "person",
	[entityAttributesProperty]: { role: ["a"], name: "bravo", personLayout: null },
};
const node4 = {
	_uid: 4,
	type: "person",
	[entityAttributesProperty]: { role: ["a"], name: "echo", personLayout: [1, 1] },
};
const node5 = {
	_uid: 5,
	type: "person",
	[entityAttributesProperty]: { role: [2], name: "charlie", personLayout: [1, 1] },
};
...
const node10 = {
	_uid: 10,
	type: "place",
	[entityAttributesProperty]: { role: [2], name: "juliet", placeLayout: [1, 1] },
};
