...
export const getActiveProtocolName = createSelector(getCurrentSessionProtocol, (protocol) => protocol && protocol.name);

export const getAssetManifest = createSelector(getCurrentSessionProtocol, (protocol) => protocol.assetManifest);
...
export const getProtocolStages = createSelector(getCurrentSessionProtocol, (protocol) => withFinishStage(protocol.stages));
