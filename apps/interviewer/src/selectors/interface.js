...
export const makeGetIds = () => createSelector(propStageId, propPromptId, (stageId, promptId) => ({ stageId, promptId }));

export const makeGetAdditionalAttributes = () => createSelector(propStage, propPrompt, (stage, prompt) => getAdditionalAttributes(stage, prompt));

export const makeGetSubject = () => createSelector(propStage, propPrompt, (stage, prompt) => getSubject(stage, prompt));
...
export const makeGetPromptVariable = () => createSelector(propPrompt, (prompt) => prompt.variable);
...
export const makeNetworkNodesForPrompt = () => {
  const getNetworkNodesForSubject = makeNetworkNodesForType();
  return createSelector(getNetworkNodesForSubject, propPromptId, (nodes, promptId) => filter(nodes, (node) => includes(node.promptIDs, promptId)));
};
