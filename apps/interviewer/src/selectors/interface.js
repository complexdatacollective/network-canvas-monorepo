...
export const makeGetIds = () =>
	createSelector(propStageId, propPromptId, (stageId, promptId) => ({ stageId, promptId }));

export const makeGetAdditionalAttributes = () =>
	createSelector(propStage, propPrompt, (stage, prompt) => getAdditionalAttributes(stage, prompt));
...
export const makeNetworkNodesForPrompt = () => {
	const getNetworkNodesForSubject = makeNetworkNodesForType();
	return createSelector(getNetworkNodesForSubject, propPromptId, (nodes, promptId) =>
