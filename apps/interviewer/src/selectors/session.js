...
export const getCaseId = createDeepEqualSelector(getActiveSession, (session) => session?.caseId);
...
export const getStageSubjectType = () => createDeepEqualSelector(getStageSubject(), (subject) => subject?.type);
