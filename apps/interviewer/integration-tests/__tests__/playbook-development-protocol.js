...
export const createNode = async (app, { name = "foo", nickname = "bar", age = 66, toggleGroup = "Four" }) => {
	...
	// toggle group
	await app.client.$('[name="e343a91f-628d-4175-870c-957beffa0154"]').click(`label*=${toggleGroup}`);
