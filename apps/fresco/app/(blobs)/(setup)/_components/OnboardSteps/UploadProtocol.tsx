	...
	return (
		<div className="flex max-w-[30rem] flex-col items-stretch justify-between">
			<div className="flex flex-col">
				...
				<Paragraph>
					If you have already created a Network Canvas protocol (<code>.netcanvas</code>) you can import it now.
				</Paragraph>
				<Paragraph>If you don&apos;t have a protocol yet, you can upload one later from the dashboard.</Paragraph>
				<ProtocolUploader className="m-14 p-6" buttonVariant="outline" buttonSize="lg" hideCancelButton />
			</div>
