		...
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						<Paragraph>
							The Fresco update you installed requires a new UploadThing API key.{" "}
							<strong>Until you add it, you will not be able to upload new protocols</strong>. Existing protocols will
						...
						<ol className="ml-4 mt-6 list-inside list-decimal">
							...
							<li>Paste the token into the field below and click &quot;save and continue&quot;.</li>
						</ol>
					</DialogDescription>
				</DialogHeader>
				<Divider />
				<UploadThingTokenForm action={(token) => setAppSetting("uploadThingToken", token)} />
			</DialogContent>
		</Dialog>
	);
}
