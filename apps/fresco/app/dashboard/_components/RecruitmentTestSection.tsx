...
export default function RecruitmentTestSection({
	...
	const buttonDisabled = !selectedProtocol || (!allowAnonymousRecruitment && !selectedParticipant);
	...
	return (
		<>
			<div className="mt-6 flex gap-4">
				...
				<Select
					onValueChange={(value) => {
						const participant = participants?.find((participant) => participant.id === value);
			...
			<div className="mt-6 flex gap-2">
				<Button disabled={buttonDisabled} onClick={() => router.push(getInterviewURL())}>
