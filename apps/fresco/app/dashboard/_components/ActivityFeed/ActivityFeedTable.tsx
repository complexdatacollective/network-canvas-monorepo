...
import { fetchActivityFeedTableColumnDefs, filterableColumns, searchableColumns } from "./ColumnDefinition";
...
export default function ActivityFeedTable({
	...
	const columns = useMemo<ColumnDef<Events, unknown>[]>(() => fetchActivityFeedTableColumnDefs(), []);
