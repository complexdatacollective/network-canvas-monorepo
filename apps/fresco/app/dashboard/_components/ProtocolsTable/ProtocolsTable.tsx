...
async function getData() {
	...
	return Promise.all([getProtocols(), getAppSetting("allowAnonymousRecruitment"), getAppSetting("uploadThingToken")]);
}
...
export default function ProtocolsTable() {
	return (
		<Suspense fallback={<DataTableSkeleton columnCount={4} filterableColumnCount={1} />}>
