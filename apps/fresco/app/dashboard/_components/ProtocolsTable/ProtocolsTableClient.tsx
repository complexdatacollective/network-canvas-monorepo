...
const ProtocolsTableClient = ({ dataPromise }: { dataPromise: GetData }) => {
	const [protocols, allowAnonymousRecruitment, hasUploadThingToken] = use(dataPromise);

	const [showAlertDialog, setShowAlertDialog] = useState(false);
	const [protocolsToDelete, setProtocolsToDelete] = useState<ProtocolWithInterviews[]>();
