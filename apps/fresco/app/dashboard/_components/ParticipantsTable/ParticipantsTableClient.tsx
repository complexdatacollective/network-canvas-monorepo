...
import { deleteAllParticipants, deleteParticipants } from "~/actions/participants";
...
export const ParticipantsTableClient = ({
	...
	const [participantsToDelete, setParticipantsToDelete] = useState<ParticipantWithInterviews[] | null>(null);
	...
	const handleDeleteItems = useCallback((items: ParticipantWithInterviews[]) => {
	...
	return (
		<>
			<DeleteParticipantsDialog
				...
				haveInterviews={!!participantsToDelete?.some((participant) => participant._count.interviews > 0)}
				...
				headerItems={
					<>
						<div className="flex flex-1 justify-start gap-2">
							...
							<GenerateParticipantURLs participants={participants} protocols={protocols} />
						</div>
