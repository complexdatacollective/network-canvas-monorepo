		...
		<>
			...
			<DropdownMenu>
				...
				<DropdownMenuContent align="end">
					...
					<DropdownMenuItem onClick={() => editParticipant(row.original)}>Edit</DropdownMenuItem>
					<DropdownMenuItem onClick={() => deleteHandler(row.original)}>Delete</DropdownMenuItem>
				</DropdownMenuContent>
			</DropdownMenu>
		</>
	);
