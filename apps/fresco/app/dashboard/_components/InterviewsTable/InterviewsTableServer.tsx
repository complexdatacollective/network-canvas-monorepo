...
export default function InterviewsTableServer() {
	...
	return (
		<Suspense fallback={<DataTableSkeleton columnCount={6} filterableColumnCount={2} />}>
			<InterviewsTable interviewsPromise={interviewsPromise} protocolsPromise={protocolsPromise} />
		</Suspense>
	);
}
