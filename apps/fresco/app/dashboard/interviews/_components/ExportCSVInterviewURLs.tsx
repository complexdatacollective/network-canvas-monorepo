...
function ExportCSVInterviewURLs({
	...
	const handleExport = () => {
		try {
			...
			toast({
				title: "Error",
				description: "An error occurred while exporting incomplete interview URLs",
				variant: "destructive",
			});
			throw new Error("An error occurred while exporting incomplete interview URLs");
		}
	...
	return (
		<Button disabled={!protocol || isExporting} onClick={handleExport} className="w-full">
