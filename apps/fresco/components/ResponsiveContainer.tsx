...
const ResponsiveContainer = ({ children, maxWidth, baseSize, className }: ContainerProps) => (
	<div className={cn(containerVariants({ maxWidth, baseSize }), className)}>{children}</div>
);
