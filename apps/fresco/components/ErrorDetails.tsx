...
export const ErrorDetails = ({
	...
	return (
		<Collapsible open={showStackTrace} onOpenChange={setShowStackTrace} className="flex flex-1 flex-col space-y-2">
			<CollapsibleTrigger className="flex items-center">
				<Heading variant="h4-all-caps">{showStackTrace ? "Hide" : "Show"} debug information</Heading>
