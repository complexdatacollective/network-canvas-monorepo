...
const SwitchWithOptimisticUpdate = ({
	...
	const [optimisticIsActive, setOptimisticIsActive] = useOptimistic(initialValue, (_, newValue: boolean) => newValue);
	...
	return (
		<SwitchUI
			...
			onCheckedChange={(checked) => startTransition(() => updateIsActive(checked))}
		/>
	);
};
