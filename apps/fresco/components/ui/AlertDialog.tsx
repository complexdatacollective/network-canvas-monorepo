...
>(({ className, children, ...props }, ref) => (
	<AlertDialogPrimitive.Overlay className={dialogOverlayClasses(className)} {...props} ref={ref} />
));
...
>(({ className, ...props }, ref) => (
	<AlertDialogPortal>
		<AlertDialogOverlay />
		<AlertDialogPrimitive.Content ref={ref} className={dialogContentClasses(className)} {...props} />
	</AlertDialogPortal>
));
...
>(({ className, children, ...props }, ref) => (
	<AlertDialogPrimitive.Description asChild ref={ref} {...props}>
		<div className={cn(paragraphVariants({ variant: "smallText" }), className)}>{children}</div>
...
>(({ className, buttonVariant, ...props }, ref) => (
	<AlertDialogPrimitive.Action
		ref={ref}
		className={cn(buttonVariants({ variant: buttonVariant ?? "destructive" }), className)}
		{...props}
	/>
));
