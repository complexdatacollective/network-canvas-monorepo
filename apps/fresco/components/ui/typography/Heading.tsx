...
export const headingVariants = cva("text-balance", {
	variants: {
		variant: {
			...
			"h4-all-caps": "scroll-m-20 text-sm font-extrabold tracking-widest uppercase",
			label:
...
const Heading = React.forwardRef<HTMLElement, HeadingProps>(({ className, variant, as, asChild, ...props }, ref) => {
