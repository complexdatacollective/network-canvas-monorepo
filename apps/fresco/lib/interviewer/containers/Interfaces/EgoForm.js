...
const elementHasOverflow = ({ clientWidth, clientHeight, scrollWidth, scrollHeight }) =>
...
const EgoForm = (props) => {
	...
	const updateEgo = useCallback(
		(modelData, attributeData) => dispatch(sessionActions.updateEgo(modelData, attributeData)),
		[dispatch],
	);
