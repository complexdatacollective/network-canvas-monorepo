...
import { getNetworkNodesForPrompt, getNodeVariables, makeGetStageNodeCount } from "../../../selectors/interface";
				...
				<div className="name-generator-roster-interface__node-panel">
					<Panel title="Added" noHighlight noCollapse>
						<div className="name-generator-roster-interface__node-list">
							...
							/>
							<AnimatePresence>
								{willAccept && <DropOverlay isOver={isOver} nodeColor={dropNodeColor} message="Drop here to add" />}
							</AnimatePresence>
						</div>
					</Panel>
				</div>
