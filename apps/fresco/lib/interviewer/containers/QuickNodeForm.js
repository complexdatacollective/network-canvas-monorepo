...
const QuickAddForm = ({ disabled, icon, nodeColor, nodeType, newNodeModelData, newNodeAttributes, targetVariable }) => {
	...
	return (
		<motion.div className="flip-form" variants={containerVariants} custom={showForm}>
			<AnimatePresence initial={false}>
				{showForm && (
					...
					>
						...
						<Node label={nodeLabel} selected={isValid} color={nodeColor} onClick={handleSubmit} />
					</motion.div>
				)}
				{!showForm && (
					<motion.div
