...
function Stage(props: StageProps) {
	...
	const CurrentInterface = getInterface(stage.type) as unknown as ElementType<StageProps>;

	return (
		<div className="flex-grow-1 relative flex h-full w-full basis-full overflow-hidden" id="stage">
			<StageErrorBoundary>
				{CurrentInterface && (
					<CurrentInterface
						key={stage.id}
