...
type ActionType = typeof SET_DESCRIPTION | typeof SET_INTERFACE_SCALE | typeof TOGGLE_SETTING | typeof SET_SETTING;
...
export default function reducer(state: DeviceSettings, action: Action): DeviceSettings {
	switch (action.type) {
...
const setSetting = (setting: keyof DeviceSettings, value: DeviceSettings[keyof DeviceSettings]) => ({
	type: SET_SETTING,
	setting,
	value,
});
