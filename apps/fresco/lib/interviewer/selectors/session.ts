...
export const getPrompts = createSelector(getCurrentStage, (stage) => stage?.prompts);
...
const getStageCount = createSelector(getProtocolStages, (stages) => stages.length);
...
export const makeGetFakeSessionProgress = createSelector(getStageCount, getPromptCount, (stageCount, promptCount) => {
