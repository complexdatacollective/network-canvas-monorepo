...
const getLayout = (_, props) => get(props, "prompt.layout.layoutVariable", null);
 ...
 */
export const getEdges = createDeepEqualSelector(getNetworkEdges, getDisplayEdges, (edges, displayEdges) =>
