...
export const getPromptModelData = createSelector(getStageSubject, getIDs, ({ type }, { stageId, promptId }) => {
	return {
		type,
		stageId,
		promptId,
...
export const getNodeIconName = createSelector(getProtocolCodebook, getSubjectType, (codebook, nodeType) => {
