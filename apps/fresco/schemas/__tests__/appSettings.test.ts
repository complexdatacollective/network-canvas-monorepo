...
import { appSettingPreprocessedSchema, appSettingsSchema, createUploadThingTokenFormSchema } from "../appSettings";
...
describe("App Settings Schema Validators", () => {
	...
	describe("App Setting Preprocessed Schema", () => {
		...
		it("should assign the default valid to invalid boolean fields", () => {
			expect(appSettingPreprocessedSchema.shape.configured.parse("Yes")).toEqual(false);

			expect(appSettingPreprocessedSchema.shape.allowAnonymousRecruitment.parse("No")).toEqual(false);

			expect(appSettingPreprocessedSchema.shape.disableAnalytics.parse("Y")).toEqual(false);
		});
		...
		it("should reject invalid date strings", () => {
			...
			expect(() => appSettingPreprocessedSchema.parse(invalidSettings)).toThrow();
		});
