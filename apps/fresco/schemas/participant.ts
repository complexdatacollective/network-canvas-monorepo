...
const hasNonWhitespaceCharacters = (input: string | undefined) => input && input.length > 0;
...
export const participantLabelRequiredSchema = z.string().trim().refine(hasNonWhitespaceCharacters, {
