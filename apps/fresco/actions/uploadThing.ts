...
import type { ArchiveResult, ExportReturn } from "~/lib/network-exporters/utils/types";
...
export const uploadZipToUploadThing = async (results: ArchiveResult): Promise<ExportReturn> => {
