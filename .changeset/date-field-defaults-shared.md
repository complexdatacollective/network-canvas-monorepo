...
`@codaco/protocol-utilities` additionally exports `addDays` and `todayYmd`, the `YYYY-MM-DD` arithmetic behind `GenerationConfig.today` and every date it generates.
