...
Add English, British English, and Spanish throughout Fresco’s researcher interface, with an account language preference that applies immediately and persists across devices. Choose the language from the globe button in the dashboard’s top bar, or in the header of the sign-in and setup screens; the choice made during setup carries over to the new account. If a choice cannot be saved, it stays in use for the visit and the language list offers to try again. Localize server-rendered pages, validation, dialogs, notifications, and structured activity details while preserving existing audit records and research data.
