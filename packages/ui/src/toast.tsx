// biome-ignore lint/style/noNamespaceImport: radix
...
const toastBaseClasses = cn(
	"group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border bg-card p-6 font-semibold shadow-lg transition-all",
...
>(({ className, ...props }, ref) => (
	<Heading variant="h4-all-caps" ref={ref} className={cn("", className)} {...props} />
));
