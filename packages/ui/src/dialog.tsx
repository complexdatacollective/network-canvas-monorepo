...
export const dialogContentClasses = 'fixed left-[50%] top-[50%] z-50 flex max-h-screen w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] flex-col duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] ';

// Variant of DialogContent that lets you provide your own content
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        dialogContentClasses,
        'gap-4 border bg-card p-6 shadow-lg sm:rounded-lg md:w-full',
        className,
      )}
      {...props}
    >
