 ...
 *
 * The narrative and network composer interfaces are the rest of it, and the
 * geospatial interface belongs to it too — it swaps the canvas for a map while
 * asking the same question about which part of the network the stage is about.
 * Each joins this object when its editor leaves `AWAITING_STAGE_EDITORS`.
 *
