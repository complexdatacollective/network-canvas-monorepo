 ...
 * `false` mean the same thing. The field seeds itself from the stage the
 * editor opened on, like every other field here — a hardcoded default would
 * register the toggle as off whatever the stage held, and turn at-risk symbols
 * off the first time an unrelated edit was saved.
 */
