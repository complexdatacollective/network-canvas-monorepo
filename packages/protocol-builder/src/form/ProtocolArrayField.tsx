...
} from './arrayFields/useArrayFieldCommands.ts';
 ...
 * through. A list the stage document keeps at a path of its own — `prompts`, or
 * a Family Pedigree's family-member form at `nodeConfig.form` — is edited with
 ...
 * onto a list that has since changed. A list nested inside a ROW has no path of
 * its own that stays true, and is left as a plain form value, committed by the
 * dialog that edits the row around it.
 */
