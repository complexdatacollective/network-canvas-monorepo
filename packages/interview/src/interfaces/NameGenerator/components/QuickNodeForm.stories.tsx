...
function QuickNodeFormWrapper(
	...
	const [addedNodes, setAddedNodes] = useState<NcNode[EntityAttributesProperty][]>([]);
	const [formShown, setFormShown] = useState(false);

	const handleAddNode = async (attributes: NcNode[EntityAttributesProperty]) => {
	...
	return (
		<div className="flex flex-col items-end gap-4">
			<QuickNodeForm {...props} addNode={handleAddNode} onShowForm={handleShowForm} />
			{formShown && (
...
export const AddNodeFlow: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "The complete flow of adding a node: click to reveal, type a name, and submit.",
			},
		},
	},
};
