...
import { labelVariants, type NodeColorSequence, truncateNodeLabel } from "@codaco/fresco-ui/Node";
import { Tooltip, TooltipContent, TooltipTrigger } from "@codaco/fresco-ui/Tooltip";
				...
				render={
					...
					>
						<motion.div
							...
							style={{
								backgroundColor: checked ? `var(--${convertToNodeColor(nodeColor)})` : "var(--primary)",
							}}
						>
							<AnimatePresence mode="popLayout" initial={false}>
								{checked ? (
									...
									>
										{fieldProps.value ? (
											<span className={labelVariants()}>{truncateNodeLabel(fieldProps.value as string)}</span>
										) : (
