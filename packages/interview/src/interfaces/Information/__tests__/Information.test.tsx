...
describe('Information size applies to video', () => {
  it('applies the LARGE size class to the video element', async () => {
    const stage = makeStage([
      { id: 'i1', type: 'asset', content: 'vid-1', size: 'LARGE' },
    ]);
    const assets: ResolvedAsset[] = [
      { assetId: 'vid-1', name: 'Clip', type: 'video', source: 'clip.mp4' },
    ];
