...
/**
 * Build a SyntheticInterview whose network demonstrates all six inheritance
 * pathways at once. The pedigree is deliberately compact so every generation is
 * visible together:
 *
 ...
 *                                  Leo (M)   Mia (F)
 *
 *   ══ marks the consanguineous union: Chris is Martin's son, so he and ego
 *   (David's daughter) are paternal first cousins.
 *
 * Conditions and the status each is designed to surface:
 *  - Huntington's (autosomal dominant): Arthur + Rose affected → ego and her
 *    children are AT RISK down the maternal line.
 ...
 *  - Haemophilia A (X-linked recessive): David, his brother Martin, and Leo
 *    affected → Irene and ego are OBLIGATE CARRIERS, Leo AFFECTED.
 ...
 *  - Y-linked hearing loss (Y-linked): Harold affected → the whole paternal male
 *    line David/Martin/Chris and ego's son Leo are OBLIGATE-AFFECTED.
