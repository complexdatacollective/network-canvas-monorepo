 ...
 * explore disease prevalence and inheritance through presets. It NEVER mutates
 * the shared interview network — it only reads the nodes/edges the source stage
 * wrote, filtered to that stage's node/edge types.
 */
