		...
		if (values.hasOtherParents === true) {
			...
			for (let i = 0; i < count; i++) {
				list.push({
					...
					name: values[`additional-parent[${String(i)}].name`] as string | undefined,
					sex: values[`additional-parent[${String(i)}].sex-at-birth`] as string | undefined,
				});
			}
		}
	...
	return (
		<>
			<div className="mb-8">
				...
				<Paragraph>
					If either parent is <strong>deceased</strong>, please answer based on whether they were partners while both
					were alive.
				</Paragraph>
			</div>
