...
const NETWORKS: Record<string, NetworkData> = {
  ...
  'Three Former Partners': buildNetwork(
    [
      { id: 'centralParent', label: fakeName('female') },
      { id: 'biologicalParent', label: fakeName('male') },
      { id: 'socialParentA', label: fakeName('male') },
      { id: 'socialParentB', label: fakeName('female') },
      {
        id: 'child',
        label: fakeName('male'),
        isEgo: true,
    ...
    [
      {
        source: 'centralParent',
        target: 'biologicalParent',
        relationshipType: 'partner',
        isActive: false,
      },
      {
        source: 'centralParent',
        target: 'socialParentA',
        relationshipType: 'partner',
        isActive: false,
      },
      {
        source: 'centralParent',
        target: 'socialParentB',
        relationshipType: 'partner',
        isActive: false,
      },
      {
      ...
      {
        source: 'biologicalParent',
        target: 'child',
        relationshipType: 'biological',
        isActive: true,
      },
      {
        source: 'socialParentA',
        target: 'child',
        relationshipType: 'social',
        isActive: true,
      },
      {
        source: 'socialParentB',
        target: 'child',
        relationshipType: 'social',
        isActive: true,
      },
