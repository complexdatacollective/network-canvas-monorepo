...
import type { EntityAttributesProperty, NcEntity } from "@codaco/shared-consts";
 ...
 *                                   node type.
 */
export const getDefaultAttributesForEntityType = (variablesForType: EntityDefinition["variables"] = {}) => {
