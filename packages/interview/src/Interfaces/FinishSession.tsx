...
const FinishSession = () => {
	...
	const finishInterviewConfirmation = async () => {
		...
		await confirm({
			...
			description: "Your responses cannot be changed after you finish the interview.",
	...
	return (
		<div className="interface">
			<Surface className="w-full max-w-2xl" noContainer>
				...
				<Paragraph>
					You have reached the end of the interview. If you are satisfied with the information you have entered, you may
					finish the interview now.
				</Paragraph>
				<Button color="primary" onClick={() => void finishInterviewConfirmation()}>
					Finish
				</Button>
			</Surface>
		</div>
