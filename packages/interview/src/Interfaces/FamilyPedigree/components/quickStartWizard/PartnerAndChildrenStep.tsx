...
export default function PartnerAndChildrenStep() {
	return (
		<>
			<Field label="Do you have a current partner?" name="hasPartner" component={BooleanField} required />
			<FieldGroup watch={["hasPartner"]} condition={(values) => values.hasPartner === true}>
