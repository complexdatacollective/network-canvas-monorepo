...
const uiSlice = createSlice({
	...
	selectors: {
		...
		showPassphrasePrompter: (state) => state.showPassphrasePrompter || state.passphraseInvalid,
...
export const { setFormIsReady, setPassphrase, setShowPassphrasePrompter, setPassphraseInvalid } = uiSlice.actions;

// Export the selectors
export const { formIsReady, getPassphrase, showPassphrasePrompter, getPassphraseInvalid } = uiSlice.selectors;
