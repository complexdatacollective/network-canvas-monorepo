...
export const BasicFields: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Demonstrates basic text and number input fields with validation.",
			},
		},
	},
};
...
export const WithAutoFocus: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "The first field is automatically focused when autoFocus is true.",
			},
		},
	},
};
...
export const SelectionFields: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Demonstrates RadioGroup (single selection) and CheckboxGroup (multiple selection) fields.",
			},
		},
	},
};
...
export const ToggleFields: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Demonstrates Toggle, Boolean (checkbox), and ToggleButtonGroup fields.",
			},
		},
	},
};
...
export const DateFields: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Demonstrates DatePicker (absolute dates) and RelativeDatePicker (relative dates) fields.",
			},
		},
	},
};
...
export const ScaleFields: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Demonstrates VisualAnalogScale (continuous) and LikertScale (discrete) fields.",
			},
		},
	},
};
...
export const ComprehensiveForm: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "A comprehensive form demonstrating all available field types processed by useProtocolForm.",
			},
		},
	},
};
...
export const UniqueValidation: Story = {
	args: {
		fields: [
			{
				variable: "nickname",
				prompt: 'Enter a unique nickname (try "Johnny" or "JaneD" to see validation error)',
			},
		],
	},
	parameters: {
...
export const SameAsValidation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Demonstrates the sameAs validation. The confirm password field must match the password field.",
			},
		},
	},
};
...
export const GreaterThanVariableValidation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Demonstrates the greaterThanVariable validation. The end age must be greater than the start age.",
			},
		},
	},
};
