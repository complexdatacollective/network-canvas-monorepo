...
export default function Canvas({
	...
	return (
		...
		>
			{/* Background layer */}
			<div className="absolute inset-0 flex items-center justify-center">{background}</div>
			...
			{nodes.map((node) => {
				...
				const highlighted = highlightAttribute ? !!node[entityAttributesProperty][highlightAttribute] : false;
				return (
					<CanvasNode
						key={nodeId}
						node={node}
