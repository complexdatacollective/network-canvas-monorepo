	...
	return (
		<Overlay show={show} title="Enter your Passphrase" onClose={onClose}>
			<div className="flex flex-col">
				...
				<p>
					Enter your passphrase in order to unlock the data on this screen. If you cannot remember your passphrase,
					please contact the person who recruited you to this study.
				</p>
