	...
	render: () => {
		...
		return (
			<div className="flex gap-4">
				<BooleanOption label="Weak" selected={selected === "weak"} onClick={() => setSelected("weak")} />
				<BooleanOption label="Moderate" selected={selected === "moderate"} onClick={() => setSelected("moderate")} />
				<BooleanOption label="Strong" selected={selected === "strong"} onClick={() => setSelected("strong")} />
				<BooleanOption
					label="No Friendship"
					negative
	...
	render: () => {
		...
		return (
			<div className="flex flex-col items-center gap-4">
				...
				<div className="grid auto-cols-fr grid-flow-col gap-4">
					<BooleanOption label="Yes" selected={selected === true} onClick={() => setSelected(true)} />
					<BooleanOption label="No" negative selected={selected === false} onClick={() => setSelected(false)} />
				</div>
			</div>
		);
	},
