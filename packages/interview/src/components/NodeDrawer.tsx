...
export default function NodeDrawer({ nodes, itemType, expanded, onExpandedChange, floating = false }: NodeDrawerProps) {
		...
		<LayoutGroup>
			...
			>
				...
				<motion.div layout="position" className="flex justify-center">
					...
					>
						<MotionChevron className="size-[1em]" animate={{ rotate: isExpanded ? 0 : 180 }} />
