...
describe('Validation Helpers', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('handles empty entity collections', () => {
      ...
      const result2 = getVariableNames(
        codebookWithEmptyCollections.ego.variables,
      );
      expect(result2).toEqual([]);
    });
