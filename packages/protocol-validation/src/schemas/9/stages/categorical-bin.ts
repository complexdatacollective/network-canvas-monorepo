...
import { categoricalBinPromptSchema, NodeStageSubjectSchema } from "../../8/common";
import { FilterSchema } from "../../8/filters";
import { baseStageEntitySchema } from "./base";

export const categoricalBinStageEntity = baseStageEntitySchema
	.extend({
		stageType: z.literal("CategoricalBin"),
