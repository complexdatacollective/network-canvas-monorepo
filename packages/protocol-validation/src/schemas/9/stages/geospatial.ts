...
import { geospatialPromptSchema, NodeStageSubjectSchema } from "../../8/common";
...
const mapOptions = z.object({
	...
	targetFeatureProperty: z
		.string()
		.generateMock(() => faker.helpers.arrayElement(["name", "location_type", "category"])),
...
export const geospatialStageEntity = baseStageEntitySchema
	.extend({
		stageType: z.literal("Geospatial"),
