...
const migrationV4toV5 = createMigration({
  ...
  to: 5,
  dependencies: {},
  notes: `- Enable the 'Tie Strength Census' interface, which will allow you to conduct a dyad census that also captures the strength of the tie and assigns it to an ordinal attribute.
