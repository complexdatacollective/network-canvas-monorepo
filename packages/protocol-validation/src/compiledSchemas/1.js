  ...
  definitions: {
    ...
    Stage: {
      ...
      properties: {
        ...
        cardOptions: { type: 'object', $ref: '#/definitions/CardOptions' },
        searchOptions: { type: 'object', $ref: '#/definitions/SearchOptions' },
        behaviours: {
          type: 'object',
    ...
    if (data.action !== undefined) {
      ...
      if (!(data0 === 'SHOW' || data0 === 'SKIP')) {
        const err4 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema55.properties.action.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err4];
    ...
    if (data.background !== undefined) {
        ...
        if (data19.concentricCircles !== undefined) {
          ...
          if (
            ...
            const err34 = {
              ...
              schemaPath:
                '#/definitions/Background/properties/concentricCircles/type',
              keyword: 'type',
              params: { type: 'integer' },
              message: 'must be integer',
            };
        ...
        if (data19.skewedTowardCenter !== undefined) {
          if (typeof data19.skewedTowardCenter !== 'boolean') {
            const err35 = {
              ...
              schemaPath:
                '#/definitions/Background/properties/skewedTowardCenter/type',
              keyword: 'type',
              params: { type: 'boolean' },
              message: 'must be boolean',
            };
      ...
      if (data19 && typeof data19 == 'object' && !Array.isArray(data19)) {
        if (Object.keys(data19).length < 1) {
          const err37 = {
            instancePath: instancePath + '/background',
            schemaPath: '#/properties/background/minProperties',
    ...
    if (data.cardOptions !== undefined) {
      ...
      if (
        !validate58(data24, {
          instancePath: instancePath + '/cardOptions',
          parentData: data,
          parentDataProperty: 'cardOptions',
          rootData,
        })
      ) {
        vErrors =
    ...
    if (data.behaviours !== undefined) {
      ...
      if (data29 && typeof data29 == 'object' && !Array.isArray(data29)) {
        if (Object.keys(data29).length < 1) {
          const err53 = {
            instancePath: instancePath + '/behaviours',
            schemaPath: '#/properties/behaviours/minProperties',
            keyword: 'minProperties',
            params: { limit: 1 },
            message: 'must NOT have fewer than 1 properties',
          };
