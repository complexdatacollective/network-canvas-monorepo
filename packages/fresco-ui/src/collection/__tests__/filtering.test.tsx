...
function FilterManagerConsumer() {
	...
	return (
		<div>
			...
			<button type="button" onClick={() => filterManager.setQuery("test")}>
				Set Query
			</button>
			<button type="button" onClick={() => filterManager.clearFilter()}>
				Clear
			</button>
		</div>
	);
...
describe("Collection Filtering", () => {
	...
	describe("useFilterManager hook", () => {
		...
		it("should throw when used outside of Collection with filterKeys", () => {
			...
			}).toThrow("useFilterManager must be used within a Collection with filterKeys configured");
	...
	describe("controlled mode", () => {
		...
		it("should update when controlled filterQuery changes", async () => {
			function ControlledWrapper() {
				...
				return (
					<>
						<button type="button" onClick={() => setQuery("updated")}>
							Update Query
						</button>
