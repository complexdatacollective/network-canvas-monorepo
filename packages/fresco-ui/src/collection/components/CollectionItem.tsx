...
import { CollectionItemContext, useCollectionId, useSelectionManager } from "../contexts";
import { useSelectableItem } from "../hooks/useSelectableItem";
import type { Layout } from "../layout/Layout";
import type { CollectionProps, ItemProps, ItemRenderer, Node } from "../types";
...
function CollectionItemComponent<T>({ node, renderItem, dragAndDropHooks, layout }: CollectionItemProps<T>) {
...
export const CollectionItem = memo(CollectionItemComponent) as typeof CollectionItemComponent;
