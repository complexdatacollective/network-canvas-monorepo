 ...
 */
export function useSelectableCollection(options: UseSelectableCollectionOptions): UseSelectableCollectionResult {
	...
	const handleTypeAhead = useCallback(
		(char: string) => {
			...
			const matchKey = keyboardDelegate.getKeyForSearch(searchRef.current, selectionManager.focusedKey ?? undefined);
	...
	const handleKeyDown = useCallback(
		...
		[selectionManager, keyboardDelegate, disallowSelectAll, options.disallowEmptySelection, handleTypeAhead],
	);
