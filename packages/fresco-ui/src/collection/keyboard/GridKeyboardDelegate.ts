...
export class GridKeyboardDelegate implements KeyboardDelegate {
	...
	constructor(collection: Collection<unknown>, columns: number, disabledKeys = new Set<Key>()) {
	...
	private skipDisabled(startKey: Key | null, direction: "forward" | "backward"): Key | null {
