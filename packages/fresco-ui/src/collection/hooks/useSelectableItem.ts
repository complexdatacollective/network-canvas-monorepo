 ...
 * ```
 */
export function useSelectableItem(options: UseSelectableItemOptions): SelectableItemResult {
	...
	const { isSelected, isFocused, isDisabled, isFocusedCollection, selectionMode } = useCollectionStore<
		unknown,
