...
export type DragAndDropHooks = {
	...
	useDroppableItemProps?: (key: Key, collectionId: string) => DroppableItemProps;
	...
	renderDropIndicator?: (target: { key: Key; position: string }) => React.ReactNode;
...
export type DragAndDropOptions<_T = unknown> = {
	 ...
	 */
	renderPreview?: (key: Key, metadata: Record<string, unknown>) => React.ReactNode;
