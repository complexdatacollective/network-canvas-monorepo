...
import type { DisabledBehavior, FocusStrategy, SelectionBehavior, SelectionMode, SelectionState } from "./types";
...
export class SelectionManager {
	...
	/** Set the focused key */
	setFocusedKey(key: Key | null, childFocusStrategy: FocusStrategy = "first"): void {
	...
	handleItemClick(
		...
		} else if (modifiers.ctrlKey || modifiers.metaKey || state.selectionBehavior === "toggle") {
			// Toggle selection
			if (currentSelection.has(key)) {
