...
type TooltipContentProps = Omit<React.ComponentPropsWithoutRef<typeof BaseTooltip.Popup>, "children"> & {
	sideOffset?: number;
...
const TooltipArrow = React.forwardRef<React.ElementRef<typeof BaseTooltip.Arrow>, TooltipArrowProps>(
	({ className, ...props }, ref) => (
		<BaseTooltip.Arrow
			ref={ref}
			className={cx(
