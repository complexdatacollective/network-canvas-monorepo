...
import { MotionConfigContext, motion, useAnimationControls, useReducedMotionConfig } from "motion/react";
...
export default function Spinner({
	...
	const { skipAnimations: skipAnimationsFromConfig } = useContext(MotionConfigContext);
	const shouldReduceMotion = !!reducedMotionFromConfig || !!skipAnimationsFromConfig;
