...
`,
	...
	argTypes: {
		orientation: {
			...
			description: "Scroll orientation. Controls which axis overflows and which fade effect is applied.",
			table: {
		...
		className: {
			description: "Classes applied to the root container. Use `publish-colors` with `bg-*` for proper fade colors.",
		},
		viewportClassName: {
			description: "Classes applied to the scrollable viewport element. Useful for additional styling.",
		},
	},
};
...
const VerticalContent = () => (
	<div className="flex flex-col gap-4 p-4">
		{Array.from({ length: 20 }, (_, i) => (
			<div key={i} className={cx("border p-4", "bg-surface-1 text-surface-1-contrast")}>
				<Heading level="h4" margin="none" className="text-base font-medium">
					Item {i + 1}
				</Heading>
				<Paragraph margin="none" className="text-sm opacity-70">
					This is some content for item {i + 1}. It demonstrates vertical scrolling.
				</Paragraph>
			</div>
		))}
	</div>
...
const HorizontalContent = () => (
	<div className="flex gap-4 p-4">
		{Array.from({ length: 15 }, (_, i) => (
			<div key={i} className={cx("shrink-0 border p-4", "bg-surface-1 text-surface-1-contrast", "w-48")}>
				<Heading level="h4" margin="none" className="text-base font-medium">
					Card {i + 1}
				</Heading>
				<Paragraph margin="none" className="text-sm opacity-70">
		...
		{Array.from({ length: 15 }, (_, rowIndex) => (
			<div key={rowIndex} className="flex gap-4">
				{Array.from({ length: 10 }, (_, colIndex) => (
					<div key={colIndex} className={cx("shrink-0 border p-4", "bg-surface-1 text-surface-1-contrast", "w-40")}>
...
export const Default: Story = {
	...
	render: (args) => (
		<ScrollArea {...args} className="bg-background publish-colors h-80 w-96 border">
			<VerticalContent />
		</ScrollArea>
	),
};
...
export const Horizontal: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Horizontal scrolling for content like carousels or wide tables.",
			},
		},
	},
	render: () => (
		<ScrollArea orientation="horizontal" className="bg-background publish-colors h-40 w-96 border">
			<HorizontalContent />
		</ScrollArea>
	),
};
...
export const Both: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Bidirectional scrolling for content that overflows in both directions, such as large data grids.",
			},
		},
	},
	render: () => (
	...
	render: () => (
		<div className="flex h-96 gap-8">
			<div className="flex flex-col gap-2">
				...
				<ScrollArea fade={true} className="bg-background publish-colors h-64 w-72 border">
					<VerticalContent />
				</ScrollArea>
			</div>
			<div className="flex flex-col gap-2">
				<span className="text-sm font-medium">Fade Off</span>
				<ScrollArea fade={false} className="bg-background publish-colors h-64 w-72 border">
					<VerticalContent />
				</ScrollArea>
			</div>
		</div>
	...
	render: () => (
		<div className="flex flex-col gap-8">
			...
			<div className="flex h-36 w-80 flex-col gap-2">
				...
				<ScrollArea orientation="horizontal" className="bg-background publish-colors border">
					<HorizontalContent />
				</ScrollArea>
			</div>
...
export const CustomViewportClass: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Use `viewportClassName` to apply styles directly to the scrollable viewport element.",
			},
		},
	},
	render: () => (
		<ScrollArea className="bg-background publish-colors h-64 w-80 border" viewportClassName="bg-surface-2">
			<VerticalContent />
		</ScrollArea>
	),
};
...
const SnapVerticalContent = () => (
	<div className="flex flex-col gap-4 p-4">
		{Array.from({ length: 10 }, (_, i) => (
			<div key={i} className={cx("snap-start border p-6", "bg-surface-1 text-surface-1-contrast", "min-h-32")}>
				<Heading level="h4" margin="none" className="font-medium">
					Snap Item {i + 1}
				</Heading>
				<Paragraph margin="none" className="text-sm opacity-70">
					This item will snap to the top when scrolling. Try scrolling slowly to see the snap effect.
				</Paragraph>
			</div>
		))}
	</div>
	...
	render: () => (
		<div className="flex gap-8">
			<div className="flex h-96 flex-col gap-2">
				...
				<ScrollArea snap="mandatory" className="publish-colors bg-background w-80 border">
					<SnapVerticalContent />
				</ScrollArea>
			</div>
			<div className="flex h-96 flex-col gap-2">
				<span className="text-sm font-medium">Proximity (snaps when close)</span>
				<ScrollArea snap="proximity" className="publish-colors bg-background w-80 border">
					<SnapVerticalContent />
				</ScrollArea>
			</div>
		</div>
...
export const ScrollSnapHorizontal: Story = {
	...
	render: () => (
		<div className="flex flex-col gap-8">
			<div className="flex flex-col gap-2">
				<span className="text-sm font-medium">Horizontal Snap (center, mandatory)</span>
				<ScrollArea orientation="horizontal" snap="mandatory" className="bg-background publish-colors h-44 w-96 border">
					<SnapHorizontalContent />
				</ScrollArea>
			</div>
			<div className="flex flex-col gap-2">
				<span className="text-sm font-medium">Horizontal Snap (center, proximity)</span>
				<ScrollArea orientation="horizontal" snap="proximity" className="bg-background publish-colors h-44 w-96 border">
					<SnapHorizontalContent />
				</ScrollArea>
			</div>
		</div>
	...
	render: () => (
		<div className="flex flex-wrap gap-6">
			<div className="flex h-96 flex-col gap-2">
				...
				<ScrollArea fade={true} className="publish-colors bg-background w-64 border">
					<VerticalContent />
				</ScrollArea>
			</div>
			<div className="flex h-96 flex-col gap-2">
				<span className="text-sm font-medium">Surface 1</span>
				<ScrollArea fade={true} className="publish-colors bg-surface-1 w-64 border">
					<VerticalContent />
				</ScrollArea>
			</div>
			<div className="flex h-96 flex-col gap-2">
				<span className="text-sm font-medium">Surface 2</span>
				<ScrollArea fade={true} className="publish-colors bg-surface-2 w-64 border">
					<VerticalContent />
				</ScrollArea>
			</div>
			<div className="flex h-96 flex-col gap-2">
				<span className="text-sm font-medium">Accent</span>
				<ScrollArea fade={true} className="publish-colors bg-accent w-64 border">
					<VerticalContent />
				</ScrollArea>
			</div>
			<div className="flex h-96 flex-col gap-2">
				<span className="text-sm font-medium">Custom Color (coral)</span>
				<ScrollArea fade={true} className="publish-colors w-64 border bg-[#ff7f50]">
					<VerticalContent />
				</ScrollArea>
			</div>
			<div className="flex h-96 flex-col gap-2">
				<span className="text-sm font-medium">Custom Color (slate)</span>
				<ScrollArea fade={true} className="publish-colors w-64 border bg-[#334155]">
					<VerticalContent />
				</ScrollArea>
			</div>
		</div>
