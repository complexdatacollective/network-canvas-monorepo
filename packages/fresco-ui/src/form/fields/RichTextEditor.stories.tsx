...
export const WithAllElements: Story = {
	render: (args) => (
		<div className="w-[600px]">
			<RichTextEditorField {...args} value={allElementsContent} onChange={action("onChange")} />
		</div>
	),
};
...
export const Disabled: Story = {
	render: (args) => (
		<div className="w-[600px]">
			<RichTextEditorField {...args} value={simpleContent} disabled onChange={action("onChange")} />
		</div>
	),
};
...
export const ReadOnly: Story = {
	render: (args) => (
		<div className="w-[600px]">
			<RichTextEditorField {...args} value={simpleContent} readOnly onChange={action("onChange")} />
		</div>
	),
};
...
export const Invalid: Story = {
	render: (args) => (
		<div className="w-[600px]">
			<RichTextEditorField {...args} value={simpleContent} aria-invalid onChange={action("onChange")} />
		</div>
	),
};
...
export const NoHeadings: Story = {
	render: (args) => (
		<div className="w-[600px]">
			<RichTextEditorField {...args} toolbarOptions={{ headings: false }} onChange={action("onChange")} />
		</div>
	),
};
...
export const NoLists: Story = {
	render: (args) => (
		<div className="w-[600px]">
			<RichTextEditorField {...args} toolbarOptions={{ lists: false }} onChange={action("onChange")} />
		</div>
	),
};
...
export const NoHistory: Story = {
	render: (args) => (
		<div className="w-[600px]">
			<RichTextEditorField {...args} toolbarOptions={{ history: false }} onChange={action("onChange")} />
		</div>
	),
};
