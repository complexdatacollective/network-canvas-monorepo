...
export const Invalid: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Textarea with invalid state styling. State priority: disabled > readOnly > invalid > normal",
			},
		},
	},
};
...
export const AllStates: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Comparison of all textarea states. Priority: disabled > readOnly > invalid > normal",
			},
		},
	},
};
...
export const WithMaxLength: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Textarea with character count and maxLength validation. Demonstrates type-safe onChange handler.",
			},
		},
	},
};
...
export const Resizable: Story = {
	...
	render: () => (
		<div className="w-full max-w-md space-y-4">
			<div>
				<Paragraph margin="none" className="mb-2 text-sm text-current opacity-70">
					The textarea is vertically resizable by default. Try dragging the bottom-right corner.
				</Paragraph>
				<TextAreaField
...
export const TypeSafeOnChange: Story = {
	...
	render: () => {
		...
		return (
			<div className="w-full max-w-md space-y-2">
				<TextAreaField value={value} onChange={(v) => setValue(v ?? "")} placeholder="Type something..." rows={5} />
				<Paragraph margin="none" className="text-xs text-current opacity-70">
