...
function ControlledVAS({
	initialValue,
	...args
}: Omit<React.ComponentProps<typeof VisualAnalogScaleField>, "value" | "onChange"> & {
	initialValue?: number;
...
export const AllStates: Story = {
	render: () => (
		<div className="flex flex-col gap-8">
			<div>
				<Paragraph margin="none" className="mb-2 text-xs font-medium text-current/50">
					Unset
				</Paragraph>
				<VisualAnalogScaleField value={undefined} minLabel="Low" maxLabel="High" />
			</div>
			<div>
				<Paragraph margin="none" className="mb-2 text-xs font-medium text-current/50">
					Normal
			...
			<div>
				...
				<VisualAnalogScaleField value={50} minLabel="Low" maxLabel="High" disabled />
			</div>
			<div>
				<Paragraph margin="none" className="mb-2 text-xs font-medium text-current/50">
					Read Only
				</Paragraph>
				<VisualAnalogScaleField value={75} minLabel="Low" maxLabel="High" readOnly />
			</div>
			<div>
				<Paragraph margin="none" className="mb-2 text-xs font-medium text-current/50">
					Invalid
				</Paragraph>
				<VisualAnalogScaleField value={50} minLabel="Low" maxLabel="High" aria-invalid={true} />
			</div>
		</div>
	),
};
