...
export const Default: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Date picker with relative date range. Allows selection within 30 days before or after today.",
			},
		},
	},
};
...
export const AllStates: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "All field states for relative date picker. State priority: disabled > readOnly > invalid > normal",
			},
		},
	},
};
...
export const PastOnly: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Date picker configured to only allow past dates by setting after=0",
			},
		},
	},
};
...
export const FutureOnly: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Date picker configured to only allow future dates by setting before=0",
			},
		},
	},
};
...
export const WithCustomAnchor: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Date picker with a custom anchor date instead of today. Useful for scheduling around specific events.",
			},
		},
	},
};
