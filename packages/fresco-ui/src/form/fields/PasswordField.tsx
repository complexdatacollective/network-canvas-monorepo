...
type PasswordFieldProps = Omit<React.ComponentProps<typeof InputField>, "type"> & {
	showStrengthMeter?: boolean;
};

export default function PasswordField({ showStrengthMeter, ...props }: PasswordFieldProps) {
	...
	return (
		<div className="flex flex-col gap-1">
			...
			{showStrengthMeter && strength && strength.score > 0 && (
				<div
					className={cx("flex items-center gap-2 transition-colors duration-200", strength.colorClass)}
					aria-live="polite"
				>
					<ProgressBar
