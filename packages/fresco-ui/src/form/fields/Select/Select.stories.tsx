...
export const UsageExamples: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Real-world usage examples showing both implementations side-by-side with the same data",
			},
		},
	},
};
...
export const LongOptionList: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Behavior with a long list of options. The styled select shows a max height with scrolling.",
			},
		},
	},
};
...
export const NumericValues: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Both components support numeric values (number type) in addition to string values",
			},
		},
	},
};
