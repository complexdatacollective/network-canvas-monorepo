 ...
 */
export default function isMatchingValue(submittedValue: unknown, existingValue: FieldValue | null): boolean {
	...
	if (
		...
		return submittedValue.x === existingValue.x && submittedValue.y === existingValue.y;
	}
