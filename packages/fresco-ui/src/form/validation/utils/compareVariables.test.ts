...
describe("compareVariables", () => {
	...
	describe("datetime comparison", () => {
		it("should return positive when first date is later", () => {
			expect(compareVariables("2024-06-01T00:00:00Z", "2024-01-01T00:00:00Z", "datetime")).toBeGreaterThan(0);
		});

		it("should return negative when first date is earlier", () => {
			expect(compareVariables("2024-01-01T00:00:00Z", "2024-06-01T00:00:00Z", "datetime")).toBeLessThan(0);
		});

		it("should return 0 when dates are equal", () => {
			expect(compareVariables("2024-01-01T00:00:00Z", "2024-01-01T00:00:00Z", "datetime")).toBe(0);
		});
	});
