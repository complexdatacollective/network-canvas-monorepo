...
export const Default: Story = {
	...
	render: (args) => (
		<Accordion {...args} key={JSON.stringify(args.defaultValue ?? [])} className="w-80">
			<AccordionItem value="overview">
				<AccordionHeader>
					<AccordionTrigger>Overview</AccordionTrigger>
				</AccordionHeader>
				<AccordionPanel>
					<p className="text-sm">The accordion expands and collapses with a smooth height and opacity transition.</p>
				</AccordionPanel>
			</AccordionItem>
			...
			<AccordionItem value="metadata">
				...
				<AccordionPanel>
					<p className="text-sm">
						Triggers inherit the heading typography. The chevron rotates automatically when the panel opens.
					</p>
				</AccordionPanel>
			</AccordionItem>
		</Accordion>
