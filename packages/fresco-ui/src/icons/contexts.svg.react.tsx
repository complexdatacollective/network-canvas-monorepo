...
export default function Icon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 66 60" {...props}>
			...
			<polygon className="fill-platinum" points="47.36 15.52 4.53 58.51 0.97 46.45 24.84 4.72 41.15 4.72 47.36 15.52" />
			<polygon
			...
			<path className="fill-white/20" d="M33,13a7.5,7.5,0,0,0-5.3,12.8L38.3,15.24A7.48,7.48,0,0,0,33,13Z" />
