...
export default function Icon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 160" {...props}>
			...
			<path className="fill-platinum" d="M1.84 134.68L74.19 10h31.56l72.41 124.68H1.84z" />
			<path className="fill-platinum-dark" d="M78 134.68l63.36-63.36 36.8 63.36H78z" />
			...
			<path className="fill-tomato-dark" d="M76.93 48.69l4.36 50.62h17.42l4.36-50.62H76.93z" />
			<path className="fill-tomato" d="M80.03 84.75l1.26 14.56h17.42l3.13-36.37-21.81 21.81z" />
			<path className="fill-platinum-dark" d="M162.5 126.68H86L52.64 160H162.5v-33.32z" />
