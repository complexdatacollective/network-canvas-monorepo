...
export default function Icon({ style, ...props }: SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    >
      ...
      <circle fill="var(--warning-icon-accent)" cx="84.29" cy="99.31" r="3" />
      <circle fill="var(--warning-icon-accent)" cx="95.71" cy="99.31" r="3" />
      <circle
        fill="var(--warning-icon-accent-dark)"
        cx="79.93"
        cy="48.69"
        r="3"
      />
      <circle
        ...
        r="3"
      />
      <path fill="var(--warning-icon-accent)" d="M84.29 96.31h11.42v6H84.29z" />
      <path
        fill="var(--warning-icon-accent-dark)"
        d="M79.93 45.69h20.15v6H79.93z"
      />
      <path
        fill="var(--warning-icon-accent-dark)"
      ...
      <path
        fill="var(--warning-icon-accent)"
        d="M81.51 131.17a12 12 0 0 0 17-17z"
      />
    </svg>
  );
}
