...
export default function Icon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" {...props}>
			...
			<path className="fill-platinum-dark" d="M0 5.14h9.43v49.71H0zM12 5.14h10.29v49.71H12z" />
			<path className="fill-platinum" d="M22.29 54.86H12V27.43l10.29-10.29v37.72z" />
			...
			<path className="fill-platinum-dark" d="M48.86 0A11.14 11.14 0 0 0 41 19L56.74 3.26A11.11 11.11 0 0 0 48.86 0z" />
		</svg>
	);
}
