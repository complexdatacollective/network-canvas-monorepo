...
export default function Icon({ style, ...props }: SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    >
      <title>Links</title>
      <circle className="fill-(--icon-tone-primary)" cx="49" cy="11" r="11" />
      <circle className="fill-(--icon-tone-primary)" cx="49" cy="49" r="11" />
      <circle className="fill-(--icon-tone-primary)" cx="11" cy="30" r="11" />
      <path
        className="fill-(--icon-tone-primary)"
      ...
      />
      <path
        className="fill-(--icon-tone-secondary)"
