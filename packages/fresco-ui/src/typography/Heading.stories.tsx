...
export const LevelCombinations: Story = {
	render: () => (
		<div className="">
			...
			<Paragraph>This is the primary heading for the page using h1 level (text-3xl).</Paragraph>

			<Heading level="h2">Section Heading</Heading>
			<Paragraph>Section headings use h2 level (text-2xl) to organize major sections.</Paragraph>
			<Heading level="h3">Subsection Heading</Heading>
			<Paragraph>Subsections use h3 level (text-xl) for nested content.</Paragraph>
			<Heading level="h4">Minor Heading</Heading>
			<Paragraph>Minor headings use h4 level (text-lg) for the smallest divisions.</Paragraph>
		</div>
	),
};
