...
export const LongContent: Story = {
	...
	render: () => (
		<div className="max-w-2xl">
			<UnorderedList>
				<li>Short items are displayed with standard line height and spacing for optimal readability.</li>
				<li>
					Longer items automatically wrap to multiple lines while maintaining proper indentation. The text flows
					naturally and the bullet point remains aligned with the first line of text, creating a clean visual
					appearance.
				</li>
				<li>
					Very long items can span multiple lines and still maintain readability through proper line height and spacing.
					The fluid type system ensures that text remains comfortable to read at all viewport sizes, adapting the scale
					ratio from 1.2 on mobile to 1.333 on desktop for optimal readability across devices.
				</li>
...
export const WithOtherTypography: Story = {
	...
	render: () => (
		<div className="max-w-2xl">
			...
			<Paragraph>
				A successful design system is built on several key principles that guide its development and usage:
			</Paragraph>
			<UnorderedList>
				<li>
					<strong>Consistency:</strong> Apply styles systematically across the entire interface to create a cohesive
					user experience
				</li>
				<li>
					<strong>Accessibility:</strong> Ensure all components meet WCAG standards and work with assistive technologies
				</li>
				<li>
					<strong>Scalability:</strong> Design components that can adapt to different contexts and grow with the product
				</li>
				<li>
					<strong>Maintainability:</strong> Create clear documentation and patterns that team members can easily
					understand and follow
				</li>
			</UnorderedList>
			<Paragraph>These principles help teams build interfaces that are both beautiful and functional.</Paragraph>
		</div>
	),
};
	...
	render: () => (
		<div className="max-w-2xl">
			...
			<Paragraph intent="lead">
				Follow these steps to set up your development environment and start building with Fresco.
			</Paragraph>

			<Heading level="h2">Prerequisites</Heading>
			<Paragraph>Before you begin, ensure you have the following installed:</Paragraph>
			<UnorderedList>
...
export const ComplexNestedStructure: Story = {
	...
	render: () => (
		<div className="max-w-2xl">
			...
			<Paragraph>The application is organized into the following directories:</Paragraph>
			<UnorderedList>
				<li>
...
export const MixedListContent: Story = {
	...
	render: () => (
		<div className="max-w-2xl">
			...
			<UnorderedList>
				<li>
					Use semantic HTML elements like <code>&lt;h1&gt;</code> through <code>&lt;h6&gt;</code> for headings
				</li>
				<li>
				...
				<li>
					<em>Italic text</em> for subtle emphasis and <strong>bold text</strong> for strong emphasis
				</li>
