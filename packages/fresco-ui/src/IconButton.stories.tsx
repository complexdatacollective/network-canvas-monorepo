	...
	render: () => (
		<div className="flex flex-col gap-4">
			<div className="flex gap-4">
				<IconButton variant="default" icon={<Plus />} aria-label="Add (Default)" />
				<IconButton variant="outline" icon={<Plus />} aria-label="Add (Outline)" />
				<IconButton variant="text" icon={<Plus />} aria-label="Add (Text)" />
				<IconButton variant="text" icon={<Plus />} aria-label="Add (Text)" />
				<IconButton variant="dashed" icon={<Plus />} aria-label="Add (Dashed)" />
			</div>
		</div>
	),
};
	...
	render: () => (
		<div className="flex flex-col gap-4">
			<div className="flex flex-wrap gap-4">
				...
				<IconButton color="secondary" icon={<Plus />} aria-label="Add Secondary" />
	...
	render: () => (
		<div className="flex flex-col gap-4">
			<div className="flex gap-4">
				...
				<IconButton icon={<Trash />} aria-label="Delete" color="destructive" variant="outline" />
...
export const States: Story = {
	render: () => (
		<div className="flex flex-col gap-4">
			...
			<div className="flex gap-4">
				<IconButton icon={<Plus />} aria-label="Normal Outline" variant="outline" />
				<IconButton icon={<Plus />} aria-label="Disabled Outline" variant="outline" disabled />
			</div>
		</div>
	),
};
...
export const ColorVariantCombinations: Story = {
	render: () => (
		<div className="grid grid-cols-[auto_repeat(5,1fr)] gap-4">
			...
			<span className="text-center text-xs font-medium text-current/70">Default</span>
			<span className="text-center text-xs font-medium text-current/70">Outline</span>
			<span className="text-center text-xs font-medium text-current/70">Text</span>
			<span className="text-center text-xs font-medium text-current/70">Dashed</span>
			<span className="text-center text-xs font-medium text-current/70">Disabled</span>
			{ICON_BUTTON_COLORS.map((color) => (
				<Fragment key={color}>
					<span className="text-sm font-medium capitalize">{color}:</span>
					<IconButton variant="default" color={color} icon={<Plus />} aria-label={`${color} default`} />
					<IconButton variant="outline" color={color} icon={<Plus />} aria-label={`${color} outline`} />
					<IconButton variant="text" color={color} icon={<Plus />} aria-label={`${color} text`} />
					<IconButton variant="dashed" color={color} icon={<Plus />} aria-label={`${color} dashed`} />
					<IconButton variant="default" color={color} icon={<Plus />} aria-label={`${color} disabled`} disabled />
				</Fragment>
			))}
		</div>
	),
			...
			{BUTTON_VARIANTS.filter((v) => v !== "dashed").map((variant) => (
				<div key={variant} className="flex flex-col gap-4">
					...
					<div className="flex items-end gap-4">
						<IconButton variant={variant} size="sm" icon={<Plus />} aria-label={`${variant} sm`} />
						<IconButton variant={variant} size="md" icon={<Plus />} aria-label={`${variant} md`} />
						<IconButton variant={variant} size="lg" icon={<Plus />} aria-label={`${variant} lg`} />
						<IconButton variant={variant} size="xl" icon={<Plus />} aria-label={`${variant} xl`} />
					</div>
				</div>
			))}
		</div>
		...
		<div className="flex flex-col gap-8">
			<div>
				...
				<div className="flex gap-2">
					...
					<IconButton icon={<Trash />} aria-label="Delete" color="destructive" variant="outline" size="sm" />
					<IconButton icon={<Check />} aria-label="Confirm" color="success" size="sm" />
					<IconButton icon={<X />} aria-label="Cancel" variant="text" size="sm" />
				</div>
			</div>
			...
			<div>
				...
				<div className="flex gap-1 rounded-lg border p-2">
					...
					<IconButton icon={<Download />} aria-label="Download" variant="text" />
					<IconButton icon={<Upload />} aria-label="Upload" variant="text" />
					<IconButton icon={<Share />} aria-label="Share" variant="text" />
					<IconButton icon={<Settings />} aria-label="Settings" variant="text" />
				</div>
			</div>
			...
			<div>
				...
				<IconButton icon={<Plus />} aria-label="Add" color="primary" size="lg" />
			</div>
		</div>
	),
};
