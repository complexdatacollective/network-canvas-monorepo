...
export const WithRadioGroup: Story = {
	render: () => {
		...
		return (
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Position: {position}</DropdownMenuTrigger>
				<DropdownMenuContent className="w-56">
					<DropdownMenuGroup>
...
export const Positioned: Story = {
	render: () => (
		<div className="flex gap-4">
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Bottom (Default)</DropdownMenuTrigger>
			...
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Top</DropdownMenuTrigger>
			...
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Left</DropdownMenuTrigger>
			...
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Right</DropdownMenuTrigger>
...
export const Aligned: Story = {
	render: () => (
		<div className="flex gap-4">
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Align Start</DropdownMenuTrigger>
			...
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Align Center</DropdownMenuTrigger>
			...
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button variant="outline" />}>Align End</DropdownMenuTrigger>
...
export const Complex: Story = {
	render: () => {
		...
		return (
			<DropdownMenu>
				<DropdownMenuTrigger render={<Button />}>Open Complex Menu</DropdownMenuTrigger>
				<DropdownMenuContent className="w-56">
					<DropdownMenuGroup>
						<DropdownMenuLabel>My Account</DropdownMenuLabel>
					</DropdownMenuGroup>
