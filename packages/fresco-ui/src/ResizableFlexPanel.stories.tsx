...
export const OverrideBasis: Story = {
	...
	args: {
		storageKey: "story-override",
		children: [<Panel key="a" label="A" color="#6366f1" />, <Panel key="b" label="B" color="#0ea5e9" />],
	},
};
...
export const NameGeneratorMockup: Story = {
	args: {
		...
		className: "h-full",
		children: [
			<div key="sidebar" className="flex h-full flex-col gap-3 rounded-lg bg-[#1e1b4b] p-4">
				<div className="rounded bg-[#6366f1]/30 p-3 text-sm text-white">Panel 1: Existing Nodes</div>
				<div className="rounded bg-[#8b5cf6]/30 p-3 text-sm text-white">Panel 2: External Data</div>
			</div>,
			<div key="main" className="flex h-full flex-wrap content-start gap-3 rounded-lg bg-[#0f172a] p-4">
