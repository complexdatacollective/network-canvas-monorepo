    ...
    docs: {
      description: {
        component: [
          ...
          'in. The trailing command sits in the popup but outside the listbox,',
          'so the list holds only options.',
          '',
          'A segment is `ready` or `loading`, and there is NO failure state: a',
          'list that could not be read is the host’s to report. Supply your own',
          'recovery — this control will not.',
        ].join('\n'),
      },
    },
  },
