...
const externalLinkRenderer = ({ href, children }: { href?: string; children?: ReactNode }) => (
...
const defaultMarkdownRenderers = {
	...
	h1: ({ children }: { children?: ReactNode }) => <Heading level="h1">{children}</Heading>,
	...
	h4: ({ children }: { children?: ReactNode }) => <Heading level="h4">{children}</Heading>,
	h5: ({ children }: { children?: ReactNode }) => <Heading level="h4">{children}</Heading>,
	h6: ({ children }: { children?: ReactNode }) => <Heading level="h4">{children}</Heading>,
	p: Paragraph,
	ul: UnorderedList,
	ol: OrderedList,
};
