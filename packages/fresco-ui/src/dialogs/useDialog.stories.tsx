...
function NestedConfirmationFooter({ onConfirm, onCancel }: { onConfirm: () => void; onCancel: () => void }) {
	...
	render: () => {
		...
		const acknowledgeDialog = async () => {
			...
			const result = await openDialog({
				...
				description: "This dialog only requires acknowledgment. Click OK to continue.",
