...
Per the authoring guide, `assetManifest` is omitted and no images are embedded. If the gallery
entry wants a hero/illustration, suitable openly-licensed candidates (verify licence before use):
...
Do not embed clinical or distressing imagery; favour warm, connection-themed visuals consistent
with the supportive-but-honest tone of the template.
