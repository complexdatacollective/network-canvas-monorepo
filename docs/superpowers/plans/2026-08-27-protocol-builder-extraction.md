...
| [#1490](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1490) — staged resource gateway                                                                                    | In progress                          | Gateway contract, in-memory adapter, shared contract suite, dangling-reference detection, and the session lifecycle (staging for the edit session, discard on cancel, atomic promotion inside finish, withholding of staged references from live-applying hosts) in [PR #1691](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1691); the picker and preview components are in [PR #1698](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1698).                                                                     |
...
| [#1486](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1486)–[#1488](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1488) — all 19 named editors | Planned                              | Begin after their shared codebook, rule, array/dialog, and resource dependencies exist; do not rebuild those dependencies inside individual editors.                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| [#1548](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1548) — skip logic, rules, filters, and automatic naming                                                           | In progress                          | Automatic naming lands in [PR #1690](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1690) (pure helpers moved, package hook reading subject/prompts/panels/codebook from context, `assets` exposed on package context); rule editing and the skip-logic and network-filter Sections follow on `feat/protocol-builder-skip-logic-rules` once the shared `DialogForm` primitive (#1688) merges.                                                                                                                                             |
| [#1486](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1486)–[#1488](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1488) — all 19 named editors | Planned                              | Begin after their shared codebook, rule, array/dialog, and resource dependencies exist; do not rebuild those dependencies inside individual editors.                                                                                                                                                                                                                                                                                                                                                                                                             |
| [#1493](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1493) — Studio-compatible Redux-free proof host                                                                    | Package-completion gate              | Exercise the completed package after all editor families and shared dependencies land. Its acceptance criteria must pass before Architect adoption begins.                                                                                                                                                                                                                                                                                                                                                                                                       |
| [#1491](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1491) — Architect adoption                                                                                         | **Deferred until feature complete**  | Do not route Architect stage editing through the package or add its live session adapter until #1493 passes against the completed package.                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [#1492](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1492) — Redux and app-local implementation removal                                                                 | Blocked by #1491                     | Remove the old seam only after every Architect stage flow has adopted the feature-complete package.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
