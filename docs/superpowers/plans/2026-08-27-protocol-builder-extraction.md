...
| [#1487](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1487) — census and bin stage editors                                                                               | In review (PR #1773)                         | The five census and bin editors — Categorical Bin, Ordinal Bin, Dyad Census, One-to-Many Dyad Census, and Tie-Strength Census — are open in [PR #1773](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1773), not yet merged. They fill their part of the exhaustive registry and add the shared prompt machinery (participant-facing prompt control, prompt codebook helpers, prompt-attribute creation, and edge-type creation) every prompt list in the package reuses. `@codaco/protocol-builder` reports 3,160 tests passed and `build-storybook` 55 stories, including this family's five Editing/Spectating pairs. #1487 stays open until #1773 lands.                                                       |
...
6. Implement #1486–#1488 against those shared seams and complete the exhaustive
   ...
   attribute primitives are open in PR #1693, not yet merged. The census and
   bin editors (#1487) are in review in PR #1773; the remaining named editors
   still follow. Do not route any of these editors through Architect as they
   land.
