...
| [#1490](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1490) — staged resource gateway                                                                                    | In progress                          | Gateway contract, in-memory adapter, shared contract suite, dangling-reference detection, and the session lifecycle (staging for the edit session, discard on cancel, atomic promotion inside finish, withholding of staged references from live-applying hosts) in [PR #1691](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1691); the picker and preview components follow on `feat/protocol-builder-resource-pickers`.                                                                                                                |
