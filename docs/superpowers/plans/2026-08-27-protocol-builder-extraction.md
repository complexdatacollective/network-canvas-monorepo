...
| [#1490](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1490) — staged resource gateway                                                                                    | Done                                | Gateway contract, in-memory adapter, shared contract suite, dangling-reference detection, and the session lifecycle (staging for the edit session, discard on cancel, atomic promotion inside finish, withholding of staged references from live-applying hosts) merged in [PR #1691](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1691); the resource pickers and preview components merged in [PR #1698](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1698).                                                                                                                                                                      |
| [#1548](https://github.com/complexdatacollective/network-canvas-monorepo/issues/1548) — skip logic, rules, filters, and automatic naming                                                           | Done                                | Automatic naming merged in [PR #1690](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1690) (pure helpers moved, package hook reading subject/prompts/panels/codebook from context, `assets` exposed on package context); rule editing and the skip-logic and network-filter Sections merged in [PR #1696](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1696) once the shared `DialogForm` primitive ([PR #1688](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1688)) landed.                                                                                                                                  |
...
4. ~~Implement #1490~~ independently of #1489 so resource-consuming editors do
   not invent host storage behavior — the gateway core merged in PR #1691 and
   the resource pickers merged in PR #1698.
5. ~~Implement #1548~~ once #1489 supplied its read model — automatic naming
   merged in PR #1690 and rule editing, skip logic, and network filtering
   merged in PR #1696.
