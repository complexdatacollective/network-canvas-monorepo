...
6. Implement #1486–#1488 against those shared seams and complete the exhaustive
   ...
   `DialogForm` primitive merged in PR #1688; the array, dialog, option-row and
   attribute primitives, and the in-place re-seeding stage editor shell, are
   open in PR #1693, not yet merged. The named
   editors still follow. Do not route any of these editors through Architect
   as they land.
