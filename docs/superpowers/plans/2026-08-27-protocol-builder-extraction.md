...
6. Implement #1486–#1488 against those shared seams and complete the exhaustive
   package dispatcher. Shared authoring primitives merged in PR #1689 and PR
   #1693; the named editors still follow. Do not route any of these editors
   through Architect as they land.
