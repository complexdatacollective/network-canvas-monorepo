...
Status: shared prerequisite #1702 is merged and verified on main. Runtime follow-up #1719 and the three app PRs are undergoing canonical image, CI and current-head review gates. Delivery remains in progress.
...
## September 6 clarified interview interface contract
...
The new interface work is implemented in the separate runtime follow-up #1719.
All three apps have integrated its source and are completing their final delivery
gates. The original prerequisite #1702 has merged; details are recorded below.

The user subsequently authorized merging any PRs, explicitly including #1702,
when ready. Delivery now includes merging the localization PRs in dependency
...
The runtime follow-up and all three app PRs are open and ready for review, with
draft status removed as the user requested. Historical draft, head and
integration-hold entries below do not describe current readiness.

### Current delivery checkpoint

| PR                                                                                                               | Current result                                                                                                                                                                                                                                                                                | Remaining delivery gate                                                                                                                                                                                     |
| ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [#1702 shared prerequisites](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1702)         | Merged at `39f59598be90c8413a49710364db477c7a3c2711`; fetched main contains both the reviewed resolution head and merge commit. Current-head Codex verdict 5561162799 is clean; zero unresolved threads. CI run 34050712489 and merge-group run 34052002205 passed.                           | Complete.                                                                                                                                                                                                   |
| [#1719 interview interface language](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1719) | Ready on `main`, implementation head `5128f4942c67dee5e8690fd43852887b23a24593`; 1,710 runtime units, 293 native cases without snapshot writes, 244 cold browser stories and final static/build gates pass.                                                                                   | Finish the one accessibility-announcement review fix and its sibling, commit approved PNGs and CI consumer corrections, pass latest-head CI/review, merge and verify ancestry.                              |
| [#1705 Architect](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1705)                    | Source correction `9c18eab06be65e1497fd0e2a88fc3b32a5f73360` has 52 focused unit passes, 6 production language passes and complete static/build guards. Normal merge `aeeffb615634d60211b0c06a96f6807aea26150c` includes final runtime `185eec160`; all 21 approved app-file hashes survived. | Four current-head findings corrected; 1,825 EN/ES and 37 GB entries reviewed. Push, repeat canonical Architect captures, review/adopt explained changes, then require fresh Codex and main CI before merge. |
| [#1703 Interviewer](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1703)                  | Complete host preference, home/setup chooser and queued finish-copy integration; 640 units and 99 cold stories pass. All 49 native cases and a real installed/offline Chromium PWA workflow pass at `4dbad13`.                                                                                | Case ID thread resolved; eight byte-stable canonical images approved for adoption. Current-head review, final runtime integration, main CI and merge remain.                                                |
| [#1704 Fresco](https://github.com/complexdatacollective/network-canvas-monorepo/pull/1704)                       | Integrated host request with a temporary interview-menu override; 672 units, fresh Next production build, app stories and static gates pass. Final isolated production workflows pass; pushed head `61f6ab7` has a clean current-head Codex verdict and zero unresolved threads.              | Merge final runtime checkpoint, retarget to main, pass current-head required CI/review and merge.                                                                                                           |

App PRs temporarily target `feat/interview-interface-i18n` for app-only diffs.
The CI workflow filters automatic pull-request runs to `main`; interim manual
`force_run=true` / `release_app=none` dispatches do not select E2E. Local native
evidence and the dedicated canonical image workflow therefore remain separate.
Once #1719 lands, retarget each app PR to main and require fresh automatic CI.
No historical or stacked dispatch verdict substitutes for that gate.
...
| Workstream                                 | Owner                        | Branch / worktree                                                          | PR and next action                                                                                                    |
| ------------------------------------------ | ---------------------------- | -------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Shared prerequisites                       | Lead                         | `feat/app-i18n-spanish-prerequisites`; `/private/tmp/nc-i18n-shared-merge` | #1702 merged and verified on main.                                                                                    |
| Interview built-in interface language      | Lead                         | `feat/interview-interface-i18n`; original worktree                         | #1719 on main; inspect canonical images, complete current-head CI/review and merge.                                   |
| Architect #1616                            | Architect agent              | `feat/architect-app-i18n`; `/private/tmp/nc-i18n-architect`                | #1705 includes runtime 185eec160; four review fixes verified; repeat canonical images/review, then main CI and merge. |
| Interviewer #1617                          | Interviewer agent            | `feat/interviewer-app-i18n`; `/private/tmp/nc-i18n-interviewer`            | #1703 on runtime branch; finish installed/offline proof, canonical images and app review, then main CI and merge.     |
| Fresco #1618                               | Fresco agent                 | `feat/fresco-app-i18n`; `/private/tmp/nc-i18n-fresco`                      | #1704 on runtime branch; finish isolated production proof and app review, then main CI and merge.                     |
| Independent Spanish and integration review | Separate app owners and lead | All app worktrees plus shared branch                                       | Source/catalog review complete; lead inspects final app deltas, visual candidates and combined delivery.              |

The lead exclusively owns shared catalogs, shared packages, Studio compatibility edits, and root dependency configuration. After merging shared checkpoints, each app owner may update only its isolated app importer in the lockfile; the lead reviews the additive diff before integration. Agents own their app manifests, source, generated English catalog, Spanish/GB catalogs, app plan, and app changeset. Shared changes land once and merge normally into each dependent branch. No cherry-picked duplicates. Intended merge order: shared prerequisite #1702, runtime follow-up #1719, then the three independently reviewable app PRs. If CI remains base-filtered to `main`, select an evidence-backed supported run or clearly record that external gate; do not treat missing CI as passing.

## Acceptance and evidence matrix

The implementation evidence below is current at runtime head `5128f4942`; exact
app checkpoints and log provenance are recorded in the per-app plans and current
delivery table above. Historical verification sections below preserve earlier
findings and do not replace the outstanding final CI, image and review gates.

| Requirement                                                 | Current implementation and evidence                                                                                                                                                                                                                                                                                                 | Remaining gate                                                                                                                              |
| ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| Existing facade, namespaced descriptors and owning catalogs | All target source censuses complete; common/shared messages reused through `@codaco/app-i18n`; extraction, description, ICU/token and client-boundary guards pass.                                                                                                                                                                  | Current-head CI.                                                                                                                            |
| Complete neutral Spanish and sparse British English         | Independent AI reviews cover 405 shared, 1,825 Architect (plus 37 sparse GB overrides), 446 Interviewer, 841 Fresco and 446 runtime entries; later wording deltas reviewed separately.                                                                                                                                              | Final delta audit; no claim of human translation certification.                                                                             |
| Studio supported subset                                     | Client/server registry remains its declared en/en-GB subset; shared ecosystem Spanish does not advertise unsupported Studio coverage. Eight subset tests, actual build and final client types pass.                                                                                                                                 | Landed in #1702.                                                                                                                            |
| Shared HTTP negotiation and source/published catalogs       | Pure Accept-Language parser, Vite/Next compilation, real Fresco production build, library/declaration and packed-export checks pass.                                                                                                                                                                                                | Landed in #1702; runtime follow-up CI.                                                                                                      |
| Package-owned interface locale                              | Public requestedLocale accepts raw/resolved requests or ordered lists, negotiates its own registry, and supports an optional controlled preference and persistence callback. Malformed, unsupported, regional and changing requests are covered.                                                                                    | #1719 final review.                                                                                                                         |
| Offline and provider-optional behavior                      | Static runtime catalogs, English standalone fallback, independent providers and no package storage/browser-global dependency; actual native offline locale workflow passes.                                                                                                                                                         | Final installed Interviewer workflow and CI.                                                                                                |
| Protocol and research data preservation                     | Locale changes retain literal authored prompts, options, identifiers and answers; browser and store-level comparisons prove unchanged data except intended ordinary user saves.                                                                                                                                                     | Final Fresco/Interviewer checkpoint records.                                                                                                |
| Retained interface state and isolation                      | Required errors, queued dialogs, values, focus, navigation and writes retain identity; simultaneous Shell notifications and NameGenerator portals remain scoped even with duplicate node IDs. Deliberate mutations fail the relevant assertions.                                                                                    | #1719 final review.                                                                                                                         |
| Host integration                                            | Architect full/inline previews inherit app language with an independent full-preview menu; Interviewer home/setup/settings and Shell share its device preference; Fresco initializes from its serialized host locale and keeps interview overrides temporary.                                                                       | App current-head review and main CI.                                                                                                        |
| Errors and recovery                                         | Actionable localized validation, import/migration, download/export and finish guidance; raw diagnostic detail remains explicitly labelled. Real finish refusal/retry and already-open translated dialog tests pass.                                                                                                                 | App final workflow records and CI.                                                                                                          |
| Responsive and accessible controls                          | PIN layout/focus and detached announcements fixed; Architect 38 editor/viewport combinations and keyboard/live-error workflows pass; actual Fresco 390px controls inspected; Interviewer phone/keyboard evidence ready.                                                                                                             | Final lead image inspection.                                                                                                                |
| Runtime verification                                        | 1,710 units plus two existing todos; 293 native scenarios without snapshot writes; 244 cold browser stories; final types, lint, format, Knip and host/library builds pass.                                                                                                                                                          | Current-head CI.                                                                                                                            |
| Shared control verification                                 | 408 affected field units and 66 browser field/radio/PIN cases pass; provider-less and rich literal labels remain covered.                                                                                                                                                                                                           | Current-head CI.                                                                                                                            |
| App verification                                            | Architect prior full checkpoint: 2,504 units plus three todos, 169 native cases and 15 cold stories; latest corrective source: 52 focused units and 6 production language workflows; Interviewer 640 units and 99 cold stories; Fresco 672 units, production build and stories pass. Exact final browser matrices in per-app plans. | Finish bounded app workflow checks and current-head CI.                                                                                     |
| ARIA and pixels                                             | 572 semantic ARIA updates independently reviewed, six serialization-only diffs restored; deliberate accessible-name loss fails the corpus guard. Canonical PNG workflows use pushed production source in CI.                                                                                                                        | Inspect every changed PNG, compare independent captures and adopt only explained changes.                                                   |
| Changesets and attribution                                  | Correct normal library/app lanes; all commits retain Joshua author/committer; no assistant attribution. Changeset guard passes.                                                                                                                                                                                                     | Final PR descriptions and clean trees.                                                                                                      |
| Review and merge                                            | #1702 latest-head Codex review, required and merge-group checks passed; reviewed head and merge commit are ancestors of freshly fetched main. All other PRs are ready, with explicit current-head review required after final changes.                                                                                              | Clean current-head verdicts, resolved actionable threads, required/merge-group checks, dependency-ordered merges and ancestry verification. |
