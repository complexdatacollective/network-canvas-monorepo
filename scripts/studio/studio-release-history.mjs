...
export async function authenticateStudioReleaseHistory(
  ...
  return {
    ...
    // The signed installer contract advertises only transitions exercised by
    // this release. Retained intermediate history remains authenticated for
    // ancestry, but it is not an unqualified compatibility promise.
    upgradeFrom: qualificationSources.map(({ current }) => current),
